...
0000000080000000 <_entry>:
    ...
    80000016:	74c060ef          	jal	ra,80006762 <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	102080e7          	jalr	258(ra) # 8000715c <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	1a2080e7          	jalr	418(ra) # 80007210 <release>
}
    ...
    8000008e:	b88080e7          	jalr	-1144(ra) # 80006c12 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fd8080e7          	jalr	-40(ra) # 800070cc <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	030080e7          	jalr	48(ra) # 8000715c <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	0cc080e7          	jalr	204(ra) # 80007210 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	0a2080e7          	jalr	162(ra) # 80007210 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	f2a080e7          	jalr	-214(ra) # 8000726e <lockfree_read4>
    ...
    80000368:	8f8080e7          	jalr	-1800(ra) # 80006c5c <printf>
  ...
  scheduler();        
    ...
    80000430:	236080e7          	jalr	566(ra) # 80006662 <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	e24080e7          	jalr	-476(ra) # 80006258 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	76c080e7          	jalr	1900(ra) # 80006c12 <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5ea080e7          	jalr	1514(ra) # 80006c12 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	34c080e7          	jalr	844(ra) # 80006c12 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	20a080e7          	jalr	522(ra) # 80006c12 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	0b4080e7          	jalr	180(ra) # 80006c12 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e54080e7          	jalr	-428(ra) # 80006c12 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	2e2080e7          	jalr	738(ra) # 800070cc <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	2ca080e7          	jalr	714(ra) # 800070cc <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	294080e7          	jalr	660(ra) # 800070cc <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	266080e7          	jalr	614(ra) # 80007110 <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2ec080e7          	jalr	748(ra) # 800071b0 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	328080e7          	jalr	808(ra) # 80007210 <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	228080e7          	jalr	552(ra) # 8000715c <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f52:	2c2080e7          	jalr	706(ra) # 80007210 <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	094080e7          	jalr	148(ra) # 8000715c <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	13a080e7          	jalr	314(ra) # 80007210 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	0bc080e7          	jalr	188(ra) # 80007210 <release>
    return 0;
    ...
    80001170:	0a4080e7          	jalr	164(ra) # 80007210 <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  release(&p->lock);
    ...
    800011ec:	028080e7          	jalr	40(ra) # 80007210 <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	f10080e7          	jalr	-240(ra) # 80007210 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	ebe080e7          	jalr	-322(ra) # 80007210 <release>
  acquire(&wait_lock);
    ...
    80001368:	df8080e7          	jalr	-520(ra) # 8000715c <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	e9e080e7          	jalr	-354(ra) # 80007210 <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	de0080e7          	jalr	-544(ra) # 8000715c <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e84080e7          	jalr	-380(ra) # 80007210 <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	de8080e7          	jalr	-536(ra) # 80007210 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	d22080e7          	jalr	-734(ra) # 8000715c <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c80080e7          	jalr	-896(ra) # 800070e2 <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	c28080e7          	jalr	-984(ra) # 8000715c <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	cc6080e7          	jalr	-826(ra) # 80007210 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	be4080e7          	jalr	-1052(ra) # 8000715c <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c8e080e7          	jalr	-882(ra) # 80007210 <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c70080e7          	jalr	-912(ra) # 80007210 <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	bb2080e7          	jalr	-1102(ra) # 8000715c <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b70080e7          	jalr	-1168(ra) # 8000715c <acquire>
    havekids = 0;
    ...
    8000168e:	ad2080e7          	jalr	-1326(ra) # 8000715c <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b76080e7          	jalr	-1162(ra) # 80007210 <release>
        havekids = 1;
    ...
    800016ba:	b5a080e7          	jalr	-1190(ra) # 80007210 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	af8080e7          	jalr	-1288(ra) # 80007210 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	a26080e7          	jalr	-1498(ra) # 8000715c <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	422080e7          	jalr	1058(ra) # 80006c12 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	922080e7          	jalr	-1758(ra) # 8000715c <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	902080e7          	jalr	-1790(ra) # 8000715c <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	9a2080e7          	jalr	-1630(ra) # 80007210 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	38c080e7          	jalr	908(ra) # 80006c12 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	8ac080e7          	jalr	-1876(ra) # 8000715c <acquire>
    if(p->pid == pid){
    ...
    800018c4:	950080e7          	jalr	-1712(ra) # 80007210 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	92e080e7          	jalr	-1746(ra) # 80007210 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	292080e7          	jalr	658(ra) # 80006c5c <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	250080e7          	jalr	592(ra) # 80006c5c <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	246080e7          	jalr	582(ra) # 80006c5c <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	5f0080e7          	jalr	1520(ra) # 800070cc <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	5a6080e7          	jalr	1446(ra) # 8000715c <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	63a080e7          	jalr	1594(ra) # 80007210 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	016080e7          	jalr	22(ra) # 80006c5c <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	42c080e7          	jalr	1068(ra) # 8000707c <uartintr>
      plic_complete(irq);
    ...
    80001c74:	d78080e7          	jalr	-648(ra) # 800059e8 <e1000_intr>
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	584080e7          	jalr	1412(ra) # 8000726e <lockfree_read4>
    ...
    80001d02:	f14080e7          	jalr	-236(ra) # 80006c12 <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	564080e7          	jalr	1380(ra) # 8000726e <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	53a080e7          	jalr	1338(ra) # 8000726e <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	ede080e7          	jalr	-290(ra) # 80006c5c <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	ec6080e7          	jalr	-314(ra) # 80006c5c <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	e0e080e7          	jalr	-498(ra) # 80006c12 <panic>
    ...
    80001e18:	dfe080e7          	jalr	-514(ra) # 80006c12 <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	e36080e7          	jalr	-458(ra) # 80006c5c <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	d38080e7          	jalr	-712(ra) # 80006c12 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	c1a080e7          	jalr	-998(ra) # 80006c5c <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	ff4080e7          	jalr	-12(ra) # 8000715c <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	054080e7          	jalr	84(ra) # 80007210 <release>
  return 0;
    ...
    800021e2:	032080e7          	jalr	50(ra) # 80007210 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	f2e080e7          	jalr	-210(ra) # 8000715c <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	fca080e7          	jalr	-54(ra) # 80007210 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e4e080e7          	jalr	-434(ra) # 800070cc <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e56080e7          	jalr	-426(ra) # 8000715c <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	eca080e7          	jalr	-310(ra) # 80007210 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	88e080e7          	jalr	-1906(ra) # 80006c12 <panic>
      b->dev = dev;
    ...
    800023a8:	e6c080e7          	jalr	-404(ra) # 80007210 <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	7fe080e7          	jalr	2046(ra) # 80006c12 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	d10080e7          	jalr	-752(ra) # 8000715c <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d7a080e7          	jalr	-646(ra) # 80007210 <release>
}
    ...
    800024b6:	760080e7          	jalr	1888(ra) # 80006c12 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c8e080e7          	jalr	-882(ra) # 8000715c <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	d2c080e7          	jalr	-724(ra) # 80007210 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c52080e7          	jalr	-942(ra) # 8000715c <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	cf0080e7          	jalr	-784(ra) # 80007210 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	66c080e7          	jalr	1644(ra) # 80006c12 <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	5a6080e7          	jalr	1446(ra) # 80006c12 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	460080e7          	jalr	1120(ra) # 80006c12 <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	986080e7          	jalr	-1658(ra) # 8000715c <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	9f4080e7          	jalr	-1548(ra) # 80007210 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	9c4080e7          	jalr	-1596(ra) # 80007210 <release>
}
    ...
    80002872:	3a4080e7          	jalr	932(ra) # 80006c12 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	324080e7          	jalr	804(ra) # 80006c12 <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	7b8080e7          	jalr	1976(ra) # 800070cc <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	240080e7          	jalr	576(ra) # 80006c12 <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	698080e7          	jalr	1688(ra) # 8000715c <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	736080e7          	jalr	1846(ra) # 80007210 <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0ec080e7          	jalr	236(ra) # 80006c12 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	06a080e7          	jalr	106(ra) # 80006c12 <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	01e080e7          	jalr	30(ra) # 80006c12 <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	49e080e7          	jalr	1182(ra) # 8000715c <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	534080e7          	jalr	1332(ra) # 80007210 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	500080e7          	jalr	1280(ra) # 80007210 <release>
    itrunc(ip);
    ...
    80002d4a:	416080e7          	jalr	1046(ra) # 8000715c <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	c0e080e7          	jalr	-1010(ra) # 80006c12 <panic>
    ...
    80003018:	bfe080e7          	jalr	-1026(ra) # 80006c12 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c8c080e7          	jalr	-884(ra) # 800070cc <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c88080e7          	jalr	-888(ra) # 8000715c <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	ce4080e7          	jalr	-796(ra) # 80007210 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	c00080e7          	jalr	-1024(ra) # 8000715c <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c8c080e7          	jalr	-884(ra) # 80007210 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	bc0080e7          	jalr	-1088(ra) # 8000715c <acquire>
    log.committing = 0;
    ...
    800035b8:	c5c080e7          	jalr	-932(ra) # 80007210 <release>
}
    ...
    800035da:	63c080e7          	jalr	1596(ra) # 80006c12 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	c1e080e7          	jalr	-994(ra) # 80007210 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	aac080e7          	jalr	-1364(ra) # 8000715c <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	aa6080e7          	jalr	-1370(ra) # 80007210 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	934080e7          	jalr	-1740(ra) # 800070cc <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	990080e7          	jalr	-1648(ra) # 8000715c <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	a16080e7          	jalr	-1514(ra) # 80007210 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	93a080e7          	jalr	-1734(ra) # 8000715c <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	9d2080e7          	jalr	-1582(ra) # 80007210 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	8f4080e7          	jalr	-1804(ra) # 8000715c <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	998080e7          	jalr	-1640(ra) # 80007210 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	80c080e7          	jalr	-2036(ra) # 800070cc <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	87a080e7          	jalr	-1926(ra) # 8000715c <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	902080e7          	jalr	-1790(ra) # 80007210 <release>
  return 0;
    ...
    8000392a:	8ea080e7          	jalr	-1814(ra) # 80007210 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	80e080e7          	jalr	-2034(ra) # 8000715c <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	8a8080e7          	jalr	-1880(ra) # 80007210 <release>
  return f;
}
    ...
    80003988:	28e080e7          	jalr	654(ra) # 80006c12 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	7b2080e7          	jalr	1970(ra) # 8000715c <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	828080e7          	jalr	-2008(ra) # 80007210 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	99e080e7          	jalr	-1634(ra) # 800063a6 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	91e080e7          	jalr	-1762(ra) # 80006436 <sockread>
  ...
  return r;
    ...
    80003ba8:	06e080e7          	jalr	110(ra) # 80006c12 <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	90c080e7          	jalr	-1780(ra) # 80006506 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	f3a080e7          	jalr	-198(ra) # 80006c12 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	384080e7          	jalr	900(ra) # 800070cc <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	386080e7          	jalr	902(ra) # 8000715c <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	416080e7          	jalr	1046(ra) # 80007210 <release>
    kfree((char*)pi);
    ...
    80003e30:	3e4080e7          	jalr	996(ra) # 80007210 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	2fa080e7          	jalr	762(ra) # 8000715c <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	390080e7          	jalr	912(ra) # 80007210 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	2ee080e7          	jalr	750(ra) # 80007210 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	204080e7          	jalr	516(ra) # 8000715c <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	224080e7          	jalr	548(ra) # 80007210 <release>
  return i;
}
    ...
    80004010:	204080e7          	jalr	516(ra) # 80007210 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	afe080e7          	jalr	-1282(ra) # 80006c12 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	6cc080e7          	jalr	1740(ra) # 80006c12 <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	232080e7          	jalr	562(ra) # 80006c12 <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	262080e7          	jalr	610(ra) # 80006280 <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	e36080e7          	jalr	-458(ra) # 800070cc <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	87a080e7          	jalr	-1926(ra) # 80006c12 <panic>
    ...
    800053ac:	86a080e7          	jalr	-1942(ra) # 80006c12 <panic>
    ...
    800053bc:	85a080e7          	jalr	-1958(ra) # 80006c12 <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d66080e7          	jalr	-666(ra) # 8000715c <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	be0080e7          	jalr	-1056(ra) # 80007210 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	ab2080e7          	jalr	-1358(ra) # 8000715c <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	ad4080e7          	jalr	-1324(ra) # 80007210 <release>
}
    ...
    8000575c:	4ba080e7          	jalr	1210(ra) # 80006c12 <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	94c080e7          	jalr	-1716(ra) # 800070cc <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	460080e7          	jalr	1120(ra) # 80005c9a <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	316080e7          	jalr	790(ra) # 80006c12 <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005922:	83e080e7          	jalr	-1986(ra) # 8000715c <acquire>
  uint32 index = regs[E1000_TDT];//获取下一个数据包的TX环索引位置
  ...
  if(tx_ring[index].status != E1000_TXD_STAT_DD){
    ...
    80005948:	08f71763          	bne	a4,a5,800059d6 <e1000_transmit+0xd2>
        __sync_synchronize();
        release(&e1000_lock);
        return -1;
  }
    ...
    8000596a:	38c080e7          	jalr	908(ra) # 80005cf2 <mbuffree>
    }//释放mbuf 防止内存泄漏
    tx_ring[index].addr = (uint64)m->head;
    8000596e:	00019517          	auipc	a0,0x19
    80005972:	69250513          	addi	a0,a0,1682 # 8001f000 <e1000_lock>
    80005976:	02049713          	slli	a4,s1,0x20
    8000597a:	9301                	srli	a4,a4,0x20
    8000597c:	00471793          	slli	a5,a4,0x4
    80005980:	97aa                	add	a5,a5,a0
    80005982:	00893683          	ld	a3,8(s2)
    80005986:	f394                	sd	a3,32(a5)
    tx_ring[index].length = m->len;
    80005988:	01092683          	lw	a3,16(s2)
    8000598c:	02d79423          	sh	a3,40(a5)
    tx_ring[index].cmd = E1000_TXD_CMD_RS | E1000_TXD_CMD_EOP;
    80005990:	46a5                	li	a3,9
    80005992:	02d785a3          	sb	a3,43(a5)
    tx_ring[index].cso = 0;
    80005996:	02078523          	sb	zero,42(a5)
    tx_ring[index].css = 0;
    8000599a:	020786a3          	sb	zero,45(a5)
    //数据包内存地址、长度、描述符cmd字段、cso、css
    tx_mbufs[index] = m;
    8000599e:	070e                	slli	a4,a4,0x3
    800059a0:	972a                	add	a4,a4,a0
    800059a2:	13273023          	sd	s2,288(a4) # 4120 <_entry-0x7fffbee0>
    //保存指针 待后续释放
    regs[E1000_TDT] = (index + 1) % TX_RING_SIZE;
    800059a6:	2485                	addiw	s1,s1,1
    800059a8:	88bd                	andi	s1,s1,15
    800059aa:	00004797          	auipc	a5,0x4
    800059ae:	6767b783          	ld	a5,1654(a5) # 8000a020 <regs>
    800059b2:	6711                	lui	a4,0x4
    800059b4:	97ba                	add	a5,a5,a4
    800059b6:	8097ac23          	sw	s1,-2024(a5)
    //取模更新环
  }
  __sync_synchronize();
    800059ba:	0ff0000f          	fence
  release(&e1000_lock);
    800059be:	00002097          	auipc	ra,0x2
    800059c2:	852080e7          	jalr	-1966(ra) # 80007210 <release>
  return 0;
    ...
    800059ce:	6942                	ld	s2,16(sp)
    800059d0:	69a2                	ld	s3,8(sp)
    800059d2:	6145                	addi	sp,sp,48
    800059d4:	8082                	ret
        __sync_synchronize();
    800059d6:	0ff0000f          	fence
        release(&e1000_lock);
    800059da:	854e                	mv	a0,s3
    800059dc:	00002097          	auipc	ra,0x2
    800059e0:	834080e7          	jalr	-1996(ra) # 80007210 <release>
        return -1;
    800059e4:	557d                	li	a0,-1
    800059e6:	b7cd                	j	800059c8 <e1000_transmit+0xc4>

00000000800059e8 <e1000_intr>:
  }
}
...
e1000_intr(void)
{
    ...
    800059fa:	e45e                	sd	s7,8(sp)
    800059fc:	e062                	sd	s8,0(sp)
    800059fe:	0880                	addi	s0,sp,80
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    80005a00:	00004797          	auipc	a5,0x4
    80005a04:	6207b783          	ld	a5,1568(a5) # 8000a020 <regs>
    80005a08:	577d                	li	a4,-1
    80005a0a:	0ce7a023          	sw	a4,192(a5)
  uint32 index = regs[E1000_RDT];
    80005a0e:	670d                	lui	a4,0x3
    80005a10:	97ba                	add	a5,a5,a4
    80005a12:	8187a783          	lw	a5,-2024(a5)
  index = (index + 1) % RX_RING_SIZE;
    80005a16:	2785                	addiw	a5,a5,1
    80005a18:	00f7f993          	andi	s3,a5,15
  struct rx_desc* dest = &rx_ring[index];
    80005a1c:	00499793          	slli	a5,s3,0x4
    80005a20:	00019497          	auipc	s1,0x19
    80005a24:	78048493          	addi	s1,s1,1920 # 8001f1a0 <rx_ring>
    80005a28:	94be                	add	s1,s1,a5
  while (rx_ring[index].status & E1000_RXD_STAT_DD){
    80005a2a:	00019717          	auipc	a4,0x19
    80005a2e:	5d670713          	addi	a4,a4,1494 # 8001f000 <e1000_lock>
    80005a32:	97ba                	add	a5,a5,a4
    80005a34:	1ac7c783          	lbu	a5,428(a5)
    80005a38:	8b85                	andi	a5,a5,1
    80005a3a:	cbd1                	beqz	a5,80005ace <e1000_intr+0xe6>
    acquire(&e1000_lock);
    80005a3c:	893a                	mv	s2,a4
    regs[E1000_RDT] = index;
    80005a3e:	00004a97          	auipc	s5,0x4
    80005a42:	5e2a8a93          	addi	s5,s5,1506 # 8000a020 <regs>
    80005a46:	6a0d                	lui	s4,0x3
    dest = &rx_ring[index];
    80005a48:	00019b17          	auipc	s6,0x19
    80005a4c:	758b0b13          	addi	s6,s6,1880 # 8001f1a0 <rx_ring>
    acquire(&e1000_lock);
    80005a50:	854a                	mv	a0,s2
    80005a52:	00001097          	auipc	ra,0x1
    80005a56:	70a080e7          	jalr	1802(ra) # 8000715c <acquire>
    struct mbuf *buf = rx_mbufs[index];//临时变量 是必要的
    80005a5a:	00399b93          	slli	s7,s3,0x3
    80005a5e:	9bca                	add	s7,s7,s2
    80005a60:	2a0bbc03          	ld	s8,672(s7)
    mbufput(buf, dest->length);//标记数据的长度
    80005a64:	0084d583          	lhu	a1,8(s1)
    80005a68:	8562                	mv	a0,s8
    80005a6a:	00000097          	auipc	ra,0x0
    80005a6e:	1d4080e7          	jalr	468(ra) # 80005c3e <mbufput>
    if (!(rx_mbufs[index] = mbufalloc(0)))
    80005a72:	4501                	li	a0,0
    80005a74:	00000097          	auipc	ra,0x0
    80005a78:	226080e7          	jalr	550(ra) # 80005c9a <mbufalloc>
    80005a7c:	2aabb023          	sd	a0,672(s7)
    80005a80:	c13d                	beqz	a0,80005ae6 <e1000_intr+0xfe>
    dest->addr = (uint64)rx_mbufs[index]->head;
    80005a82:	651c                	ld	a5,8(a0)
    80005a84:	e09c                	sd	a5,0(s1)
    dest->status = 0;
    80005a86:	00048623          	sb	zero,12(s1)
    regs[E1000_RDT] = index;
    80005a8a:	000ab783          	ld	a5,0(s5)
    80005a8e:	97d2                	add	a5,a5,s4
    80005a90:	8137ac23          	sw	s3,-2024(a5)
    __sync_synchronize();
    80005a94:	0ff0000f          	fence
    release(&e1000_lock);
    80005a98:	854a                	mv	a0,s2
    80005a9a:	00001097          	auipc	ra,0x1
    80005a9e:	776080e7          	jalr	1910(ra) # 80007210 <release>
    net_rx(buf);
    80005aa2:	8562                	mv	a0,s8
    80005aa4:	00000097          	auipc	ra,0x0
    80005aa8:	3c2080e7          	jalr	962(ra) # 80005e66 <net_rx>
    index = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005aac:	000ab783          	ld	a5,0(s5)
    80005ab0:	97d2                	add	a5,a5,s4
    80005ab2:	8187a783          	lw	a5,-2024(a5)
    80005ab6:	2785                	addiw	a5,a5,1
    80005ab8:	00f7f993          	andi	s3,a5,15
    dest = &rx_ring[index];
    80005abc:	00499793          	slli	a5,s3,0x4
    80005ac0:	00fb04b3          	add	s1,s6,a5
  while (rx_ring[index].status & E1000_RXD_STAT_DD){
    80005ac4:	97ca                	add	a5,a5,s2
    80005ac6:	1ac7c783          	lbu	a5,428(a5)
    80005aca:	8b85                	andi	a5,a5,1
    80005acc:	f3d1                	bnez	a5,80005a50 <e1000_intr+0x68>

  e1000_recv();
}
    80005ace:	60a6                	ld	ra,72(sp)
    80005ad0:	6406                	ld	s0,64(sp)
    80005ad2:	74e2                	ld	s1,56(sp)
    80005ad4:	7942                	ld	s2,48(sp)
    80005ad6:	79a2                	ld	s3,40(sp)
    80005ad8:	7a02                	ld	s4,32(sp)
    80005ada:	6ae2                	ld	s5,24(sp)
    80005adc:	6b42                	ld	s6,16(sp)
    80005ade:	6ba2                	ld	s7,8(sp)
    80005ae0:	6c02                	ld	s8,0(sp)
    80005ae2:	6161                	addi	sp,sp,80
    80005ae4:	8082                	ret
      panic("mbuf alloc failed");
    80005ae6:	00004517          	auipc	a0,0x4
    80005aea:	d0250513          	addi	a0,a0,-766 # 800097e8 <syscalls+0x410>
    80005aee:	00001097          	auipc	ra,0x1
    80005af2:	124080e7          	jalr	292(ra) # 80006c12 <panic>

0000000080005af6 <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005af8:	ec22                	sd	s0,24(sp)
    80005afa:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005afc:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005b02:	04b7d963          	bge	a5,a1,80005b54 <in_cksum+0x5e>
    80005b06:	ffe5879b          	addiw	a5,a1,-2
    80005b0a:	0017d61b          	srliw	a2,a5,0x1
    80005b0e:	0017d71b          	srliw	a4,a5,0x1
    80005b12:	0705                	addi	a4,a4,1
    80005b14:	0706                	slli	a4,a4,0x1
    80005b16:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005b18:	4781                	li	a5,0
    sum += *w++;
    80005b1a:	0509                	addi	a0,a0,2
    80005b1c:	ffe55683          	lhu	a3,-2(a0)
    80005b20:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b22:	fee51ce3          	bne	a0,a4,80005b1a <in_cksum+0x24>
    80005b26:	35f9                	addiw	a1,a1,-2
    80005b28:	0016169b          	slliw	a3,a2,0x1
    80005b2c:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }

  /* mop up an odd byte, if necessary */
  if (nleft == 1) {
    80005b2e:	4685                	li	a3,1
    80005b30:	02d58563          	beq	a1,a3,80005b5a <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b34:	03079513          	slli	a0,a5,0x30
    80005b38:	9141                	srli	a0,a0,0x30
    80005b3a:	0107d79b          	srliw	a5,a5,0x10
    80005b3e:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b40:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b44:	9d3d                	addw	a0,a0,a5
    80005b46:	fff54513          	not	a0,a0
  return answer;
}
    80005b4a:	1542                	slli	a0,a0,0x30
    80005b4c:	9141                	srli	a0,a0,0x30
    80005b4e:	6462                	ld	s0,24(sp)
    80005b50:	6105                	addi	sp,sp,32
    80005b52:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b54:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b56:	4781                	li	a5,0
    80005b58:	bfd9                	j	80005b2e <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b5a:	00074703          	lbu	a4,0(a4)
    80005b5e:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b62:	fee45703          	lhu	a4,-18(s0)
    80005b66:	9fb9                	addw	a5,a5,a4
    80005b68:	b7f1                	j	80005b34 <in_cksum+0x3e>

0000000080005b6a <mbufpull>:
{
  ...
  if (m->len < len)
    80005b74:	4b98                	lw	a4,16(a5)
    80005b76:	00b76b63          	bltu	a4,a1,80005b8c <mbufpull+0x22>
  m->len -= len;
    80005b7a:	9f0d                	subw	a4,a4,a1
    80005b7c:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b7e:	1582                	slli	a1,a1,0x20
    80005b80:	9181                	srli	a1,a1,0x20
    80005b82:	95aa                	add	a1,a1,a0
    80005b84:	e78c                	sd	a1,8(a5)
}
    80005b86:	6422                	ld	s0,8(sp)
    80005b88:	0141                	addi	sp,sp,16
    80005b8a:	8082                	ret
    return 0;
    80005b8c:	4501                	li	a0,0
    80005b8e:	bfe5                	j	80005b86 <mbufpull+0x1c>

0000000080005b90 <mbufpush>:
{
    80005b90:	87aa                	mv	a5,a0
  m->head -= len;
    80005b92:	02059713          	slli	a4,a1,0x20
    80005b96:	9301                	srli	a4,a4,0x20
    80005b98:	6508                	ld	a0,8(a0)
    80005b9a:	8d19                	sub	a0,a0,a4
    80005b9c:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b9e:	01478713          	addi	a4,a5,20
    80005ba2:	00e56663          	bltu	a0,a4,80005bae <mbufpush+0x1e>
  m->len += len;
    80005ba6:	4b98                	lw	a4,16(a5)
    80005ba8:	9db9                	addw	a1,a1,a4
    80005baa:	cb8c                	sw	a1,16(a5)
}
    80005bac:	8082                	ret
{
    ...
    panic("mbufpush");
    80005bb6:	00004517          	auipc	a0,0x4
    80005bba:	c4a50513          	addi	a0,a0,-950 # 80009800 <syscalls+0x428>
    80005bbe:	00001097          	auipc	ra,0x1
    80005bc2:	054080e7          	jalr	84(ra) # 80006c12 <panic>

0000000080005bc6 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
  ...
  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bd8:	45b9                	li	a1,14
    80005bda:	00000097          	auipc	ra,0x0
    80005bde:	fb6080e7          	jalr	-74(ra) # 80005b90 <mbufpush>
    80005be2:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005be4:	4619                	li	a2,6
    80005be6:	00004597          	auipc	a1,0x4
    80005bea:	cda58593          	addi	a1,a1,-806 # 800098c0 <local_mac>
    80005bee:	0519                	addi	a0,a0,6
    80005bf0:	ffffa097          	auipc	ra,0xffffa
    80005bf4:	5e8080e7          	jalr	1512(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bf8:	4619                	li	a2,6
    80005bfa:	00004597          	auipc	a1,0x4
    80005bfe:	cbe58593          	addi	a1,a1,-834 # 800098b8 <broadcast_mac>
    80005c02:	8526                	mv	a0,s1
    80005c04:	ffffa097          	auipc	ra,0xffffa
    80005c08:	5d4080e7          	jalr	1492(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005c0c:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005c10:	00f48623          	sb	a5,12(s1)
    80005c14:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005c18:	854e                	mv	a0,s3
    80005c1a:	00000097          	auipc	ra,0x0
    80005c1e:	cea080e7          	jalr	-790(ra) # 80005904 <e1000_transmit>
    80005c22:	e901                	bnez	a0,80005c32 <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
  ...
  kfree(m);
    ...
    80005c34:	ffffa097          	auipc	ra,0xffffa
    80005c38:	3e8080e7          	jalr	1000(ra) # 8000001c <kfree>
}
    80005c3c:	b7e5                	j	80005c24 <net_tx_eth+0x5e>

0000000080005c3e <mbufput>:
{
    80005c3e:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c40:	4918                	lw	a4,16(a0)
    80005c42:	02071693          	slli	a3,a4,0x20
    80005c46:	9281                	srli	a3,a3,0x20
    80005c48:	6508                	ld	a0,8(a0)
    80005c4a:	9536                	add	a0,a0,a3
  m->len += len;
    80005c4c:	9f2d                	addw	a4,a4,a1
    80005c4e:	0007069b          	sext.w	a3,a4
    80005c52:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c54:	6785                	lui	a5,0x1
    80005c56:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c5a:	00d7e363          	bltu	a5,a3,80005c60 <mbufput+0x22>
}
    80005c5e:	8082                	ret
{
    ...
    80005c6c:	ba850513          	addi	a0,a0,-1112 # 80009810 <syscalls+0x438>
    80005c70:	00001097          	auipc	ra,0x1
    80005c74:	fa2080e7          	jalr	-94(ra) # 80006c12 <panic>

0000000080005c78 <mbuftrim>:
{
    80005c78:	1141                	addi	sp,sp,-16
    80005c7a:	e422                	sd	s0,8(sp)
    80005c7c:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c7e:	491c                	lw	a5,16(a0)
    80005c80:	00b7eb63          	bltu	a5,a1,80005c96 <mbuftrim+0x1e>
  m->len -= len;
    80005c84:	9f8d                	subw	a5,a5,a1
    80005c86:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c88:	1782                	slli	a5,a5,0x20
    80005c8a:	9381                	srli	a5,a5,0x20
    80005c8c:	6508                	ld	a0,8(a0)
    80005c8e:	953e                	add	a0,a0,a5
}
    80005c90:	6422                	ld	s0,8(sp)
    80005c92:	0141                	addi	sp,sp,16
    80005c94:	8082                	ret
    return 0;
    80005c96:	4501                	li	a0,0
    80005c98:	bfe5                	j	80005c90 <mbuftrim+0x18>

0000000080005c9a <mbufalloc>:
{
    80005c9a:	1101                	addi	sp,sp,-32
    80005c9c:	ec06                	sd	ra,24(sp)
    80005c9e:	e822                	sd	s0,16(sp)
    80005ca0:	e426                	sd	s1,8(sp)
    80005ca2:	e04a                	sd	s2,0(sp)
    80005ca4:	1000                	addi	s0,sp,32
  if (headroom > MBUF_SIZE)
    80005ca6:	6785                	lui	a5,0x1
    80005ca8:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005cac:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005cae:	02a7eb63          	bltu	a5,a0,80005ce4 <mbufalloc+0x4a>
    80005cb2:	84aa                	mv	s1,a0
  m = kalloc();
    80005cb4:	ffffa097          	auipc	ra,0xffffa
    80005cb8:	464080e7          	jalr	1124(ra) # 80000118 <kalloc>
    80005cbc:	892a                	mv	s2,a0
  if (m == 0)
    80005cbe:	c11d                	beqz	a0,80005ce4 <mbufalloc+0x4a>
  m->next = 0;
    80005cc0:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005cc4:	0551                	addi	a0,a0,20
    80005cc6:	1482                	slli	s1,s1,0x20
    80005cc8:	9081                	srli	s1,s1,0x20
    80005cca:	94aa                	add	s1,s1,a0
    80005ccc:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005cd0:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005cd4:	6605                	lui	a2,0x1
    80005cd6:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cda:	4581                	li	a1,0
    80005cdc:	ffffa097          	auipc	ra,0xffffa
    80005ce0:	49c080e7          	jalr	1180(ra) # 80000178 <memset>
}
...
0000000080005cf2 <mbuffree>:
{
  ...
  kfree(m);
    80005cfa:	ffffa097          	auipc	ra,0xffffa
    80005cfe:	322080e7          	jalr	802(ra) # 8000001c <kfree>
}
    80005d02:	60a2                	ld	ra,8(sp)
    80005d04:	6402                	ld	s0,0(sp)
    80005d06:	0141                	addi	sp,sp,16
    80005d08:	8082                	ret

0000000080005d0a <mbufq_pushtail>:
{
  ...
  if (!q->head){
    80005d14:	611c                	ld	a5,0(a0)
    80005d16:	c799                	beqz	a5,80005d24 <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005d18:	651c                	ld	a5,8(a0)
    80005d1a:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d1c:	e50c                	sd	a1,8(a0)
}
    80005d1e:	6422                	ld	s0,8(sp)
    80005d20:	0141                	addi	sp,sp,16
    80005d22:	8082                	ret
    q->head = q->tail = m;
    80005d24:	e50c                	sd	a1,8(a0)
    80005d26:	e10c                	sd	a1,0(a0)
    return;
    80005d28:	bfdd                	j	80005d1e <mbufq_pushtail+0x14>

0000000080005d2a <mbufq_pophead>:
{
  ...
  struct mbuf *head = q->head;
    80005d32:	6108                	ld	a0,0(a0)
  if (!head)
    80005d34:	c119                	beqz	a0,80005d3a <mbufq_pophead+0x10>
  q->head = head->next;
    80005d36:	6118                	ld	a4,0(a0)
    80005d38:	e398                	sd	a4,0(a5)
}
    80005d3a:	6422                	ld	s0,8(sp)
    80005d3c:	0141                	addi	sp,sp,16
    80005d3e:	8082                	ret

0000000080005d40 <mbufq_empty>:
{
    80005d40:	1141                	addi	sp,sp,-16
    80005d42:	e422                	sd	s0,8(sp)
    80005d44:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d46:	6108                	ld	a0,0(a0)
}
    80005d48:	00153513          	seqz	a0,a0
    80005d4c:	6422                	ld	s0,8(sp)
    80005d4e:	0141                	addi	sp,sp,16
    80005d50:	8082                	ret

0000000080005d52 <mbufq_init>:
{
  ...
  q->head = 0;
    ...
    80005d5c:	6422                	ld	s0,8(sp)
    80005d5e:	0141                	addi	sp,sp,16
    80005d60:	8082                	ret

0000000080005d62 <net_tx_udp>:
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d6c:	e44e                	sd	s3,8(sp)
    80005d6e:	e052                	sd	s4,0(sp)
    80005d70:	1800                	addi	s0,sp,48
    80005d72:	8a2a                	mv	s4,a0
    80005d74:	892e                	mv	s2,a1
    80005d76:	89b2                	mv	s3,a2
    80005d78:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d7a:	45a1                	li	a1,8
    80005d7c:	00000097          	auipc	ra,0x0
    80005d80:	e14080e7          	jalr	-492(ra) # 80005b90 <mbufpush>
    80005d84:	0089d61b          	srliw	a2,s3,0x8
    80005d88:	0089999b          	slliw	s3,s3,0x8
    80005d8c:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d90:	01351023          	sh	s3,0(a0)
    80005d94:	0084d69b          	srliw	a3,s1,0x8
    80005d98:	0084949b          	slliw	s1,s1,0x8
    80005d9c:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d9e:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005da2:	010a2783          	lw	a5,16(s4) # 3010 <_entry-0x7fffcff0>
    80005da6:	0087d713          	srli	a4,a5,0x8
    80005daa:	0087979b          	slliw	a5,a5,0x8
    80005dae:	0ff77713          	andi	a4,a4,255
    80005db2:	8fd9                	or	a5,a5,a4
    80005db4:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005db8:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005dbc:	45d1                	li	a1,20
    80005dbe:	8552                	mv	a0,s4
    80005dc0:	00000097          	auipc	ra,0x0
    80005dc4:	dd0080e7          	jalr	-560(ra) # 80005b90 <mbufpush>
    80005dc8:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005dca:	4651                	li	a2,20
    80005dcc:	4581                	li	a1,0
    80005dce:	ffffa097          	auipc	ra,0xffffa
    80005dd2:	3aa080e7          	jalr	938(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005dd6:	04500793          	li	a5,69
    80005dda:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005dde:	47c5                	li	a5,17
    80005de0:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005de4:	0f0207b7          	lui	a5,0xf020
    80005de8:	27a9                	addiw	a5,a5,10
    80005dea:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005dec:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005df0:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005df4:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005df6:	0089171b          	slliw	a4,s2,0x8
    80005dfa:	00ff06b7          	lui	a3,0xff0
    80005dfe:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005e00:	8fd9                	or	a5,a5,a4
    80005e02:	0089591b          	srliw	s2,s2,0x8
    80005e06:	65c1                	lui	a1,0x10
    80005e08:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005e0c:	00b97933          	and	s2,s2,a1
    80005e10:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005e14:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005e18:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e1c:	0087d713          	srli	a4,a5,0x8
    80005e20:	0087979b          	slliw	a5,a5,0x8
    80005e24:	0ff77713          	andi	a4,a4,255
    80005e28:	8fd9                	or	a5,a5,a4
    80005e2a:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e2e:	06400793          	li	a5,100
    80005e32:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e36:	45d1                	li	a1,20
    80005e38:	8526                	mv	a0,s1
    80005e3a:	00000097          	auipc	ra,0x0
    80005e3e:	cbc080e7          	jalr	-836(ra) # 80005af6 <in_cksum>
    80005e42:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e46:	6585                	lui	a1,0x1
    80005e48:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e4c:	8552                	mv	a0,s4
    80005e4e:	00000097          	auipc	ra,0x0
    80005e52:	d78080e7          	jalr	-648(ra) # 80005bc6 <net_tx_eth>
  ...
  net_tx_ip(m, IPPROTO_UDP, dip);
    ...
    80005e5a:	64e2                	ld	s1,24(sp)
    80005e5c:	6942                	ld	s2,16(sp)
    80005e5e:	69a2                	ld	s3,8(sp)
    80005e60:	6a02                	ld	s4,0(sp)
    80005e62:	6145                	addi	sp,sp,48
    80005e64:	8082                	ret

0000000080005e66 <net_rx>:
}
...
void net_rx(struct mbuf *m)
{
    ...
    80005e6c:	fc26                	sd	s1,56(sp)
    80005e6e:	f84a                	sd	s2,48(sp)
    80005e70:	f44e                	sd	s3,40(sp)
    80005e72:	f052                	sd	s4,32(sp)
    80005e74:	ec56                	sd	s5,24(sp)
    80005e76:	0880                	addi	s0,sp,80
    80005e78:	84aa                	mv	s1,a0
  struct eth *ethhdr;
  uint16 type;

  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e7a:	45b9                	li	a1,14
    80005e7c:	00000097          	auipc	ra,0x0
    80005e80:	cee080e7          	jalr	-786(ra) # 80005b6a <mbufpull>
  if (!ethhdr) {
    80005e84:	c521                	beqz	a0,80005ecc <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e86:	00c54783          	lbu	a5,12(a0)
    80005e8a:	00d54703          	lbu	a4,13(a0)
    80005e8e:	0722                	slli	a4,a4,0x8
    80005e90:	8fd9                	or	a5,a5,a4
    80005e92:	0087979b          	slliw	a5,a5,0x8
    80005e96:	8321                	srli	a4,a4,0x8
    80005e98:	8fd9                	or	a5,a5,a4
    80005e9a:	17c2                	slli	a5,a5,0x30
    80005e9c:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e9e:	8007871b          	addiw	a4,a5,-2048
    80005ea2:	cb1d                	beqz	a4,80005ed8 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005ea4:	2781                	sext.w	a5,a5
    80005ea6:	6705                	lui	a4,0x1
    80005ea8:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005eac:	18e78e63          	beq	a5,a4,80006048 <net_rx+0x1e2>
  kfree(m);
    80005eb0:	8526                	mv	a0,s1
    80005eb2:	ffffa097          	auipc	ra,0xffffa
    80005eb6:	16a080e7          	jalr	362(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
    80005eba:	60a6                	ld	ra,72(sp)
    80005ebc:	6406                	ld	s0,64(sp)
    80005ebe:	74e2                	ld	s1,56(sp)
    80005ec0:	7942                	ld	s2,48(sp)
    80005ec2:	79a2                	ld	s3,40(sp)
    80005ec4:	7a02                	ld	s4,32(sp)
    80005ec6:	6ae2                	ld	s5,24(sp)
    80005ec8:	6161                	addi	sp,sp,80
    80005eca:	8082                	ret
  kfree(m);
    ...
    80005ed6:	b7d5                	j	80005eba <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005ed8:	45d1                	li	a1,20
    80005eda:	8526                	mv	a0,s1
    80005edc:	00000097          	auipc	ra,0x0
    80005ee0:	c8e080e7          	jalr	-882(ra) # 80005b6a <mbufpull>
    80005ee4:	892a                	mv	s2,a0
  if (!iphdr)
    80005ee6:	c519                	beqz	a0,80005ef4 <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ee8:	00054703          	lbu	a4,0(a0)
    80005eec:	04500793          	li	a5,69
    80005ef0:	00f70863          	beq	a4,a5,80005f00 <net_rx+0x9a>
  kfree(m);
    80005ef4:	8526                	mv	a0,s1
    80005ef6:	ffffa097          	auipc	ra,0xffffa
    80005efa:	126080e7          	jalr	294(ra) # 8000001c <kfree>
}
    80005efe:	bf75                	j	80005eba <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005f00:	45d1                	li	a1,20
    80005f02:	00000097          	auipc	ra,0x0
    80005f06:	bf4080e7          	jalr	-1036(ra) # 80005af6 <in_cksum>
    80005f0a:	f56d                	bnez	a0,80005ef4 <net_rx+0x8e>
    80005f0c:	00695783          	lhu	a5,6(s2)
    80005f10:	0087d713          	srli	a4,a5,0x8
    80005f14:	0087979b          	slliw	a5,a5,0x8
    80005f18:	0ff77713          	andi	a4,a4,255
    80005f1c:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f1e:	17c2                	slli	a5,a5,0x30
    80005f20:	93c1                	srli	a5,a5,0x30
    80005f22:	fbe9                	bnez	a5,80005ef4 <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f24:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f28:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f2c:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f30:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f32:	0087169b          	slliw	a3,a4,0x8
    80005f36:	00ff0637          	lui	a2,0xff0
    80005f3a:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f3c:	8fd5                	or	a5,a5,a3
    80005f3e:	0087571b          	srliw	a4,a4,0x8
    80005f42:	66c1                	lui	a3,0x10
    80005f44:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f48:	8f75                	and	a4,a4,a3
    80005f4a:	8fd9                	or	a5,a5,a4
    80005f4c:	2781                	sext.w	a5,a5
    80005f4e:	0a000737          	lui	a4,0xa000
    80005f52:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f56:	f8e79fe3          	bne	a5,a4,80005ef4 <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f5a:	00994703          	lbu	a4,9(s2)
    80005f5e:	47c5                	li	a5,17
    80005f60:	f8f71ae3          	bne	a4,a5,80005ef4 <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f64:	00295783          	lhu	a5,2(s2)
    80005f68:	0087d713          	srli	a4,a5,0x8
    80005f6c:	0087999b          	slliw	s3,a5,0x8
    80005f70:	0ff77793          	andi	a5,a4,255
    80005f74:	00f9e9b3          	or	s3,s3,a5
    80005f78:	19c2                	slli	s3,s3,0x30
    80005f7a:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f7e:	fec9879b          	addiw	a5,s3,-20
    80005f82:	03079a13          	slli	s4,a5,0x30
    80005f86:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f8a:	45a1                	li	a1,8
    80005f8c:	8526                	mv	a0,s1
    80005f8e:	00000097          	auipc	ra,0x0
    80005f92:	bdc080e7          	jalr	-1060(ra) # 80005b6a <mbufpull>
    80005f96:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f98:	c915                	beqz	a0,80005fcc <net_rx+0x166>
    80005f9a:	00455783          	lhu	a5,4(a0)
    80005f9e:	0087d713          	srli	a4,a5,0x8
    80005fa2:	0087979b          	slliw	a5,a5,0x8
    80005fa6:	0ff77713          	andi	a4,a4,255
    80005faa:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005fac:	2a01                	sext.w	s4,s4
    80005fae:	17c2                	slli	a5,a5,0x30
    80005fb0:	93c1                	srli	a5,a5,0x30
    80005fb2:	00fa1d63          	bne	s4,a5,80005fcc <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005fb6:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fba:	0107979b          	slliw	a5,a5,0x10
    80005fbe:	0107d79b          	srliw	a5,a5,0x10
    80005fc2:	0007871b          	sext.w	a4,a5
    80005fc6:	488c                	lw	a1,16(s1)
    80005fc8:	00e5f863          	bgeu	a1,a4,80005fd8 <net_rx+0x172>
  kfree(m);
    80005fcc:	8526                	mv	a0,s1
    80005fce:	ffffa097          	auipc	ra,0xffffa
    80005fd2:	04e080e7          	jalr	78(ra) # 8000001c <kfree>
}
    80005fd6:	b5d5                	j	80005eba <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fd8:	9d9d                	subw	a1,a1,a5
    80005fda:	8526                	mv	a0,s1
    80005fdc:	00000097          	auipc	ra,0x0
    80005fe0:	c9c080e7          	jalr	-868(ra) # 80005c78 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fe4:	00c92783          	lw	a5,12(s2)
    80005fe8:	000ad703          	lhu	a4,0(s5)
    80005fec:	00875693          	srli	a3,a4,0x8
    80005ff0:	0087171b          	slliw	a4,a4,0x8
    80005ff4:	0ff6f693          	andi	a3,a3,255
    80005ff8:	8ed9                	or	a3,a3,a4
    80005ffa:	002ad703          	lhu	a4,2(s5)
    80005ffe:	00875613          	srli	a2,a4,0x8
    80006002:	0087171b          	slliw	a4,a4,0x8
    80006006:	0ff67613          	andi	a2,a2,255
    8000600a:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    8000600c:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006010:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006014:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80006016:	0087959b          	slliw	a1,a5,0x8
    8000601a:	00ff0537          	lui	a0,0xff0
    8000601e:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80006020:	8f4d                	or	a4,a4,a1
    80006022:	0087d79b          	srliw	a5,a5,0x8
    80006026:	65c1                	lui	a1,0x10
    80006028:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    8000602c:	8fed                	and	a5,a5,a1
    8000602e:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80006030:	16c2                	slli	a3,a3,0x30
    80006032:	92c1                	srli	a3,a3,0x30
    80006034:	1642                	slli	a2,a2,0x30
    80006036:	9241                	srli	a2,a2,0x30
    80006038:	0007859b          	sext.w	a1,a5
    8000603c:	8526                	mv	a0,s1
    8000603e:	00000097          	auipc	ra,0x0
    80006042:	55c080e7          	jalr	1372(ra) # 8000659a <sockrecvudp>
  return;
    80006046:	bd95                	j	80005eba <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006048:	45f1                	li	a1,28
    8000604a:	8526                	mv	a0,s1
    8000604c:	00000097          	auipc	ra,0x0
    80006050:	b1e080e7          	jalr	-1250(ra) # 80005b6a <mbufpull>
    80006054:	892a                	mv	s2,a0
  if (!arphdr)
    80006056:	c179                	beqz	a0,8000611c <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006058:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    8000605c:	00154703          	lbu	a4,1(a0)
  ...
  return (((val & 0x00ffU) << 8) |
    ...
    8000606c:	17c2                	slli	a5,a5,0x30
    8000606e:	93c1                	srli	a5,a5,0x30
    80006070:	4705                	li	a4,1
    80006072:	0ae79563          	bne	a5,a4,8000611c <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006076:	00254783          	lbu	a5,2(a0)
    8000607a:	00354703          	lbu	a4,3(a0)
    8000607e:	0722                	slli	a4,a4,0x8
    80006080:	8fd9                	or	a5,a5,a4
    80006082:	0087979b          	slliw	a5,a5,0x8
    80006086:	8321                	srli	a4,a4,0x8
    80006088:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    8000608a:	0107979b          	slliw	a5,a5,0x10
    8000608e:	0107d79b          	srliw	a5,a5,0x10
    80006092:	8007879b          	addiw	a5,a5,-2048
    80006096:	e3d9                	bnez	a5,8000611c <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006098:	00454703          	lbu	a4,4(a0)
    8000609c:	4799                	li	a5,6
    8000609e:	06f71f63          	bne	a4,a5,8000611c <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    800060a2:	00554703          	lbu	a4,5(a0)
    800060a6:	4791                	li	a5,4
    800060a8:	06f71a63          	bne	a4,a5,8000611c <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060ac:	00654783          	lbu	a5,6(a0)
    800060b0:	00754703          	lbu	a4,7(a0)
    800060b4:	0722                	slli	a4,a4,0x8
    800060b6:	8fd9                	or	a5,a5,a4
    800060b8:	0087979b          	slliw	a5,a5,0x8
    800060bc:	8321                	srli	a4,a4,0x8
    800060be:	8fd9                	or	a5,a5,a4
    800060c0:	17c2                	slli	a5,a5,0x30
    800060c2:	93c1                	srli	a5,a5,0x30
    800060c4:	4705                	li	a4,1
    800060c6:	04e79b63          	bne	a5,a4,8000611c <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060ca:	01854783          	lbu	a5,24(a0)
    800060ce:	01954703          	lbu	a4,25(a0)
    800060d2:	0722                	slli	a4,a4,0x8
    800060d4:	8f5d                	or	a4,a4,a5
    800060d6:	01a54783          	lbu	a5,26(a0)
    800060da:	07c2                	slli	a5,a5,0x10
    800060dc:	8f5d                	or	a4,a4,a5
    800060de:	01b54783          	lbu	a5,27(a0)
    800060e2:	07e2                	slli	a5,a5,0x18
    800060e4:	8fd9                	or	a5,a5,a4
    800060e6:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060ea:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060ee:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060f2:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060f4:	0087169b          	slliw	a3,a4,0x8
    800060f8:	00ff0637          	lui	a2,0xff0
    800060fc:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060fe:	8fd5                	or	a5,a5,a3
    80006100:	0087571b          	srliw	a4,a4,0x8
    80006104:	66c1                	lui	a3,0x10
    80006106:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    8000610a:	8f75                	and	a4,a4,a3
    8000610c:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    8000610e:	2781                	sext.w	a5,a5
    80006110:	0a000737          	lui	a4,0xa000
    80006114:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80006118:	00e78863          	beq	a5,a4,80006128 <net_rx+0x2c2>
  kfree(m);
    8000611c:	8526                	mv	a0,s1
    8000611e:	ffffa097          	auipc	ra,0xffffa
    80006122:	efe080e7          	jalr	-258(ra) # 8000001c <kfree>
}
    80006126:	bb51                	j	80005eba <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    80006128:	4619                	li	a2,6
    8000612a:	00850593          	addi	a1,a0,8
    8000612e:	fb840513          	addi	a0,s0,-72
    80006132:	ffffa097          	auipc	ra,0xffffa
    80006136:	0a6080e7          	jalr	166(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    8000613a:	00e94783          	lbu	a5,14(s2)
    8000613e:	00f94703          	lbu	a4,15(s2)
    80006142:	0722                	slli	a4,a4,0x8
    80006144:	8f5d                	or	a4,a4,a5
    80006146:	01094783          	lbu	a5,16(s2)
    8000614a:	07c2                	slli	a5,a5,0x10
    8000614c:	8f5d                	or	a4,a4,a5
    8000614e:	01194783          	lbu	a5,17(s2)
    80006152:	07e2                	slli	a5,a5,0x18
    80006154:	8fd9                	or	a5,a5,a4
    80006156:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    8000615a:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    8000615e:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006162:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006166:	0087179b          	slliw	a5,a4,0x8
    8000616a:	00ff06b7          	lui	a3,0xff0
    8000616e:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006170:	00f96933          	or	s2,s2,a5
    80006174:	0087579b          	srliw	a5,a4,0x8
    80006178:	6741                	lui	a4,0x10
    8000617a:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    8000617e:	8ff9                	and	a5,a5,a4
    80006180:	00f96933          	or	s2,s2,a5
    80006184:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006186:	08000513          	li	a0,128
    8000618a:	00000097          	auipc	ra,0x0
    8000618e:	b10080e7          	jalr	-1264(ra) # 80005c9a <mbufalloc>
    80006192:	8a2a                	mv	s4,a0
  if (!m)
    80006194:	d541                	beqz	a0,8000611c <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    80006196:	45f1                	li	a1,28
    80006198:	00000097          	auipc	ra,0x0
    8000619c:	aa6080e7          	jalr	-1370(ra) # 80005c3e <mbufput>
    800061a0:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    800061a2:	00050023          	sb	zero,0(a0)
    800061a6:	4785                	li	a5,1
    800061a8:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    800061ac:	47a1                	li	a5,8
    800061ae:	00f50123          	sb	a5,2(a0)
    800061b2:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    800061b6:	4799                	li	a5,6
    800061b8:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061bc:	4791                	li	a5,4
    800061be:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061c2:	00050323          	sb	zero,6(a0)
    800061c6:	4a89                	li	s5,2
    800061c8:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061cc:	4619                	li	a2,6
    800061ce:	00003597          	auipc	a1,0x3
    800061d2:	6f258593          	addi	a1,a1,1778 # 800098c0 <local_mac>
    800061d6:	0521                	addi	a0,a0,8
    800061d8:	ffffa097          	auipc	ra,0xffffa
    800061dc:	000080e7          	jalr	ra # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061e0:	47a9                	li	a5,10
    800061e2:	00f98723          	sb	a5,14(s3)
    800061e6:	000987a3          	sb	zero,15(s3)
    800061ea:	01598823          	sb	s5,16(s3)
    800061ee:	47bd                	li	a5,15
    800061f0:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061f4:	4619                	li	a2,6
    800061f6:	fb840593          	addi	a1,s0,-72
    800061fa:	01298513          	addi	a0,s3,18
    800061fe:	ffffa097          	auipc	ra,0xffffa
    80006202:	fda080e7          	jalr	-38(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    80006206:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    8000620a:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000620e:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    80006210:	0089179b          	slliw	a5,s2,0x8
    80006214:	00ff06b7          	lui	a3,0xff0
    80006218:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000621a:	8f5d                	or	a4,a4,a5
    8000621c:	0089579b          	srliw	a5,s2,0x8
    80006220:	66c1                	lui	a3,0x10
    80006222:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006226:	8ff5                	and	a5,a5,a3
    80006228:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    8000622a:	00e98c23          	sb	a4,24(s3)
    8000622e:	0087d71b          	srliw	a4,a5,0x8
    80006232:	00e98ca3          	sb	a4,25(s3)
    80006236:	0107d71b          	srliw	a4,a5,0x10
    8000623a:	00e98d23          	sb	a4,26(s3)
    8000623e:	0187d79b          	srliw	a5,a5,0x18
    80006242:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    80006246:	6585                	lui	a1,0x1
    80006248:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    8000624c:	8552                	mv	a0,s4
    8000624e:	00000097          	auipc	ra,0x0
    80006252:	978080e7          	jalr	-1672(ra) # 80005bc6 <net_tx_eth>
  return 0;
    80006256:	b5d9                	j	8000611c <net_rx+0x2b6>

0000000080006258 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    ...
    80006264:	5b858593          	addi	a1,a1,1464 # 80009818 <syscalls+0x440>
    80006268:	00019517          	auipc	a0,0x19
    8000626c:	0b850513          	addi	a0,a0,184 # 8001f320 <lock>
    80006270:	00001097          	auipc	ra,0x1
    80006274:	e5c080e7          	jalr	-420(ra) # 800070cc <initlock>
}
...
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    80006288:	f04a                	sd	s2,32(sp)
    8000628a:	ec4e                	sd	s3,24(sp)
    8000628c:	e852                	sd	s4,16(sp)
    8000628e:	e456                	sd	s5,8(sp)
    80006290:	0080                	addi	s0,sp,64
    80006292:	892a                	mv	s2,a0
    80006294:	84ae                	mv	s1,a1
    80006296:	8a32                	mv	s4,a2
    80006298:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    8000629a:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    8000629e:	ffffd097          	auipc	ra,0xffffd
    800062a2:	632080e7          	jalr	1586(ra) # 800038d0 <filealloc>
    800062a6:	00a93023          	sd	a0,0(s2)
    800062aa:	c975                	beqz	a0,8000639e <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    800062ac:	ffffa097          	auipc	ra,0xffffa
    800062b0:	e6c080e7          	jalr	-404(ra) # 80000118 <kalloc>
    800062b4:	8aaa                	mv	s5,a0
    800062b6:	c15d                	beqz	a0,8000635c <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    800062b8:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062ba:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062be:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062c2:	00003597          	auipc	a1,0x3
    800062c6:	55e58593          	addi	a1,a1,1374 # 80009820 <syscalls+0x448>
    800062ca:	0541                	addi	a0,a0,16
    800062cc:	00001097          	auipc	ra,0x1
    800062d0:	e00080e7          	jalr	-512(ra) # 800070cc <initlock>
  mbufq_init(&si->rxq);
    800062d4:	028a8513          	addi	a0,s5,40
    800062d8:	00000097          	auipc	ra,0x0
    800062dc:	a7a080e7          	jalr	-1414(ra) # 80005d52 <mbufq_init>
  (*f)->type = FD_SOCK;
    800062e0:	00093783          	ld	a5,0(s2)
    800062e4:	4711                	li	a4,4
    800062e6:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062e8:	00093703          	ld	a4,0(s2)
    800062ec:	4785                	li	a5,1
    800062ee:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062f2:	00093703          	ld	a4,0(s2)
    800062f6:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062fa:	00093783          	ld	a5,0(s2)
    800062fe:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>
  ...
  acquire(&lock);
    ...
    8000630e:	e52080e7          	jalr	-430(ra) # 8000715c <acquire>
  pos = sockets;
    80006312:	00004597          	auipc	a1,0x4
    80006316:	d165b583          	ld	a1,-746(a1) # 8000a028 <sockets>
  while (pos) {
    8000631a:	c9b1                	beqz	a1,8000636e <sockalloc+0xee>
  pos = sockets;
    8000631c:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    8000631e:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    80006322:	0009869b          	sext.w	a3,s3
    80006326:	a019                	j	8000632c <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    80006328:	639c                	ld	a5,0(a5)
  while (pos) {
    8000632a:	c3b1                	beqz	a5,8000636e <sockalloc+0xee>
    if (pos->raddr == raddr &&
    8000632c:	4798                	lw	a4,8(a5)
    8000632e:	fe971de3          	bne	a4,s1,80006328 <sockalloc+0xa8>
    80006332:	00c7d703          	lhu	a4,12(a5)
    80006336:	fec719e3          	bne	a4,a2,80006328 <sockalloc+0xa8>
        pos->lport == lport &&
    8000633a:	00e7d703          	lhu	a4,14(a5)
    8000633e:	fed715e3          	bne	a4,a3,80006328 <sockalloc+0xa8>
      release(&lock);
    80006342:	00019517          	auipc	a0,0x19
    80006346:	fde50513          	addi	a0,a0,-34 # 8001f320 <lock>
    8000634a:	00001097          	auipc	ra,0x1
    8000634e:	ec6080e7          	jalr	-314(ra) # 80007210 <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    80006352:	8556                	mv	a0,s5
    80006354:	ffffa097          	auipc	ra,0xffffa
    80006358:	cc8080e7          	jalr	-824(ra) # 8000001c <kfree>
  if (*f)
    8000635c:	00093503          	ld	a0,0(s2)
    80006360:	c129                	beqz	a0,800063a2 <sockalloc+0x122>
    fileclose(*f);
    80006362:	ffffd097          	auipc	ra,0xffffd
    80006366:	62a080e7          	jalr	1578(ra) # 8000398c <fileclose>
  return -1;
    8000636a:	557d                	li	a0,-1
    8000636c:	a005                	j	8000638c <sockalloc+0x10c>
  si->next = sockets;
    8000636e:	00bab023          	sd	a1,0(s5)
  sockets = si;
    80006372:	00004797          	auipc	a5,0x4
    80006376:	cb57bb23          	sd	s5,-842(a5) # 8000a028 <sockets>
  release(&lock);
    8000637a:	00019517          	auipc	a0,0x19
    8000637e:	fa650513          	addi	a0,a0,-90 # 8001f320 <lock>
    80006382:	00001097          	auipc	ra,0x1
    80006386:	e8e080e7          	jalr	-370(ra) # 80007210 <release>
  return 0;
    8000638a:	4501                	li	a0,0
}
    8000638c:	70e2                	ld	ra,56(sp)
    8000638e:	7442                	ld	s0,48(sp)
    80006390:	74a2                	ld	s1,40(sp)
    80006392:	7902                	ld	s2,32(sp)
    80006394:	69e2                	ld	s3,24(sp)
    80006396:	6a42                	ld	s4,16(sp)
    80006398:	6aa2                	ld	s5,8(sp)
    8000639a:	6121                	addi	sp,sp,64
    8000639c:	8082                	ret
  return -1;
    8000639e:	557d                	li	a0,-1
    800063a0:	b7f5                	j	8000638c <sockalloc+0x10c>
    800063a2:	557d                	li	a0,-1
    800063a4:	b7e5                	j	8000638c <sockalloc+0x10c>

00000000800063a6 <sockclose>:
...
sockclose(struct sock *si)
{
    ...
    800063ae:	e04a                	sd	s2,0(sp)
    800063b0:	1000                	addi	s0,sp,32
    800063b2:	892a                	mv	s2,a0
  struct sock **pos;
  struct mbuf *m;

  // remove from list of sockets
  acquire(&lock);
    800063b4:	00019517          	auipc	a0,0x19
    800063b8:	f6c50513          	addi	a0,a0,-148 # 8001f320 <lock>
    800063bc:	00001097          	auipc	ra,0x1
    800063c0:	da0080e7          	jalr	-608(ra) # 8000715c <acquire>
  pos = &sockets;
    800063c4:	00004797          	auipc	a5,0x4
    800063c8:	c647b783          	ld	a5,-924(a5) # 8000a028 <sockets>
  while (*pos) {
    800063cc:	cb99                	beqz	a5,800063e2 <sockclose+0x3c>
    if (*pos == si){
    800063ce:	02f90563          	beq	s2,a5,800063f8 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063d2:	873e                	mv	a4,a5
    800063d4:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063d6:	c791                	beqz	a5,800063e2 <sockclose+0x3c>
    if (*pos == si){
    800063d8:	fef91de3          	bne	s2,a5,800063d2 <sockclose+0x2c>
      *pos = si->next;
    800063dc:	00093783          	ld	a5,0(s2)
    800063e0:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063e2:	00019517          	auipc	a0,0x19
    800063e6:	f3e50513          	addi	a0,a0,-194 # 8001f320 <lock>
    800063ea:	00001097          	auipc	ra,0x1
    800063ee:	e26080e7          	jalr	-474(ra) # 80007210 <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063f2:	02890493          	addi	s1,s2,40
    800063f6:	a839                	j	80006414 <sockclose+0x6e>
  pos = &sockets;
    800063f8:	00004717          	auipc	a4,0x4
    800063fc:	c3070713          	addi	a4,a4,-976 # 8000a028 <sockets>
    80006400:	bff1                	j	800063dc <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    80006402:	8526                	mv	a0,s1
    80006404:	00000097          	auipc	ra,0x0
    80006408:	926080e7          	jalr	-1754(ra) # 80005d2a <mbufq_pophead>
    mbuffree(m);
    8000640c:	00000097          	auipc	ra,0x0
    80006410:	8e6080e7          	jalr	-1818(ra) # 80005cf2 <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    80006414:	8526                	mv	a0,s1
    80006416:	00000097          	auipc	ra,0x0
    8000641a:	92a080e7          	jalr	-1750(ra) # 80005d40 <mbufq_empty>
    8000641e:	d175                	beqz	a0,80006402 <sockclose+0x5c>
  }

  kfree((char*)si);
    80006420:	854a                	mv	a0,s2
    80006422:	ffffa097          	auipc	ra,0xffffa
    80006426:	bfa080e7          	jalr	-1030(ra) # 8000001c <kfree>
}
...
0000000080006436 <sockread>:

int
sockread(struct sock *si, uint64 addr, int n)
{
    80006436:	7139                	addi	sp,sp,-64
    80006438:	fc06                	sd	ra,56(sp)
    8000643a:	f822                	sd	s0,48(sp)
    8000643c:	f426                	sd	s1,40(sp)
    8000643e:	f04a                	sd	s2,32(sp)
    80006440:	ec4e                	sd	s3,24(sp)
    80006442:	e852                	sd	s4,16(sp)
    80006444:	e456                	sd	s5,8(sp)
    80006446:	0080                	addi	s0,sp,64
    80006448:	84aa                	mv	s1,a0
    8000644a:	8a2e                	mv	s4,a1
    8000644c:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    8000644e:	ffffb097          	auipc	ra,0xffffb
    80006452:	a52080e7          	jalr	-1454(ra) # 80000ea0 <myproc>
    80006456:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006458:	01048993          	addi	s3,s1,16
    8000645c:	854e                	mv	a0,s3
    8000645e:	00001097          	auipc	ra,0x1
    80006462:	cfe080e7          	jalr	-770(ra) # 8000715c <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006466:	02848493          	addi	s1,s1,40
    8000646a:	8526                	mv	a0,s1
    8000646c:	00000097          	auipc	ra,0x0
    80006470:	8d4080e7          	jalr	-1836(ra) # 80005d40 <mbufq_empty>
    80006474:	c919                	beqz	a0,8000648a <sockread+0x54>
    80006476:	02892783          	lw	a5,40(s2)
    8000647a:	eba5                	bnez	a5,800064ea <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    8000647c:	85ce                	mv	a1,s3
    8000647e:	8526                	mv	a0,s1
    80006480:	ffffb097          	auipc	ra,0xffffb
    80006484:	0dc080e7          	jalr	220(ra) # 8000155c <sleep>
    80006488:	b7cd                	j	8000646a <sockread+0x34>
  }
  if (pr->killed) {
    8000648a:	02892783          	lw	a5,40(s2)
    8000648e:	efb1                	bnez	a5,800064ea <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    80006496:	898080e7          	jalr	-1896(ra) # 80005d2a <mbufq_pophead>
    8000649a:	84aa                	mv	s1,a0
  release(&si->lock);
    8000649c:	854e                	mv	a0,s3
    8000649e:	00001097          	auipc	ra,0x1
    800064a2:	d72080e7          	jalr	-654(ra) # 80007210 <release>

  len = m->len;
    800064a6:	489c                	lw	a5,16(s1)
  if (len > n)
    800064a8:	89be                	mv	s3,a5
    800064aa:	00fad363          	bge	s5,a5,800064b0 <sockread+0x7a>
    800064ae:	89d6                	mv	s3,s5
    800064b0:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    800064b2:	86ce                	mv	a3,s3
    800064b4:	6490                	ld	a2,8(s1)
    800064b6:	85d2                	mv	a1,s4
    800064b8:	05093503          	ld	a0,80(s2)
    800064bc:	ffffa097          	auipc	ra,0xffffa
    800064c0:	6aa080e7          	jalr	1706(ra) # 80000b66 <copyout>
    800064c4:	892a                	mv	s2,a0
    800064c6:	57fd                	li	a5,-1
    800064c8:	02f50863          	beq	a0,a5,800064f8 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064d2:	824080e7          	jalr	-2012(ra) # 80005cf2 <mbuffree>
  return len;
}
    800064d6:	854e                	mv	a0,s3
    800064d8:	70e2                	ld	ra,56(sp)
    800064da:	7442                	ld	s0,48(sp)
    800064dc:	74a2                	ld	s1,40(sp)
    800064de:	7902                	ld	s2,32(sp)
    800064e0:	69e2                	ld	s3,24(sp)
    800064e2:	6a42                	ld	s4,16(sp)
    800064e4:	6aa2                	ld	s5,8(sp)
    800064e6:	6121                	addi	sp,sp,64
    800064e8:	8082                	ret
    release(&si->lock);
    800064ea:	854e                	mv	a0,s3
    800064ec:	00001097          	auipc	ra,0x1
    800064f0:	d24080e7          	jalr	-732(ra) # 80007210 <release>
    return -1;
    800064f4:	59fd                	li	s3,-1
    800064f6:	b7c5                	j	800064d6 <sockread+0xa0>
    mbuffree(m);
    800064f8:	8526                	mv	a0,s1
    800064fa:	fffff097          	auipc	ra,0xfffff
    800064fe:	7f8080e7          	jalr	2040(ra) # 80005cf2 <mbuffree>
    return -1;
    80006502:	89ca                	mv	s3,s2
    80006504:	bfc9                	j	800064d6 <sockread+0xa0>

0000000080006506 <sockwrite>:

int
sockwrite(struct sock *si, uint64 addr, int n)
{
    80006506:	7139                	addi	sp,sp,-64
    80006508:	fc06                	sd	ra,56(sp)
    8000650a:	f822                	sd	s0,48(sp)
    8000650c:	f426                	sd	s1,40(sp)
    8000650e:	f04a                	sd	s2,32(sp)
    80006510:	ec4e                	sd	s3,24(sp)
    80006512:	e852                	sd	s4,16(sp)
    80006514:	e456                	sd	s5,8(sp)
    80006516:	0080                	addi	s0,sp,64
    80006518:	8aaa                	mv	s5,a0
    8000651a:	89ae                	mv	s3,a1
    8000651c:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    8000651e:	ffffb097          	auipc	ra,0xffffb
    80006522:	982080e7          	jalr	-1662(ra) # 80000ea0 <myproc>
    80006526:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006528:	08000513          	li	a0,128
    8000652c:	fffff097          	auipc	ra,0xfffff
    80006530:	76e080e7          	jalr	1902(ra) # 80005c9a <mbufalloc>
  if (!m)
    80006534:	c12d                	beqz	a0,80006596 <sockwrite+0x90>
    80006536:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    80006538:	050a3a03          	ld	s4,80(s4)
    8000653c:	85ca                	mv	a1,s2
    8000653e:	fffff097          	auipc	ra,0xfffff
    80006542:	700080e7          	jalr	1792(ra) # 80005c3e <mbufput>
    80006546:	85aa                	mv	a1,a0
    80006548:	86ca                	mv	a3,s2
    8000654a:	864e                	mv	a2,s3
    8000654c:	8552                	mv	a0,s4
    8000654e:	ffffa097          	auipc	ra,0xffffa
    80006552:	6a4080e7          	jalr	1700(ra) # 80000bf2 <copyin>
    80006556:	89aa                	mv	s3,a0
    80006558:	57fd                	li	a5,-1
    8000655a:	02f50863          	beq	a0,a5,8000658a <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    8000655e:	00ead683          	lhu	a3,14(s5)
    80006562:	00cad603          	lhu	a2,12(s5)
    80006566:	008aa583          	lw	a1,8(s5)
    8000656a:	8526                	mv	a0,s1
    8000656c:	fffff097          	auipc	ra,0xfffff
    80006570:	7f6080e7          	jalr	2038(ra) # 80005d62 <net_tx_udp>
  return n;
    80006574:	89ca                	mv	s3,s2
}
    80006576:	854e                	mv	a0,s3
    80006578:	70e2                	ld	ra,56(sp)
    8000657a:	7442                	ld	s0,48(sp)
    8000657c:	74a2                	ld	s1,40(sp)
    8000657e:	7902                	ld	s2,32(sp)
    80006580:	69e2                	ld	s3,24(sp)
    80006582:	6a42                	ld	s4,16(sp)
    80006584:	6aa2                	ld	s5,8(sp)
    80006586:	6121                	addi	sp,sp,64
    80006588:	8082                	ret
    mbuffree(m);
    8000658a:	8526                	mv	a0,s1
    8000658c:	fffff097          	auipc	ra,0xfffff
    80006590:	766080e7          	jalr	1894(ra) # 80005cf2 <mbuffree>
    return -1;
    80006594:	b7cd                	j	80006576 <sockwrite+0x70>
    return -1;
    80006596:	59fd                	li	s3,-1
    80006598:	bff9                	j	80006576 <sockwrite+0x70>

000000008000659a <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    8000659a:	7139                	addi	sp,sp,-64
    8000659c:	fc06                	sd	ra,56(sp)
    8000659e:	f822                	sd	s0,48(sp)
    800065a0:	f426                	sd	s1,40(sp)
    800065a2:	f04a                	sd	s2,32(sp)
    800065a4:	ec4e                	sd	s3,24(sp)
    800065a6:	e852                	sd	s4,16(sp)
    800065a8:	e456                	sd	s5,8(sp)
    800065aa:	0080                	addi	s0,sp,64
    800065ac:	8a2a                	mv	s4,a0
    800065ae:	892e                	mv	s2,a1
    800065b0:	89b2                	mv	s3,a2
    800065b2:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    800065b4:	00019517          	auipc	a0,0x19
    800065b8:	d6c50513          	addi	a0,a0,-660 # 8001f320 <lock>
    800065bc:	00001097          	auipc	ra,0x1
    800065c0:	ba0080e7          	jalr	-1120(ra) # 8000715c <acquire>
  si = sockets;
    800065c4:	00004497          	auipc	s1,0x4
    800065c8:	a644b483          	ld	s1,-1436(s1) # 8000a028 <sockets>
  while (si) {
    800065cc:	c4ad                	beqz	s1,80006636 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065ce:	0009871b          	sext.w	a4,s3
    800065d2:	000a869b          	sext.w	a3,s5
    800065d6:	a019                	j	800065dc <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065d8:	6084                	ld	s1,0(s1)
  while (si) {
    800065da:	ccb1                	beqz	s1,80006636 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065dc:	449c                	lw	a5,8(s1)
    800065de:	ff279de3          	bne	a5,s2,800065d8 <sockrecvudp+0x3e>
    800065e2:	00c4d783          	lhu	a5,12(s1)
    800065e6:	fee799e3          	bne	a5,a4,800065d8 <sockrecvudp+0x3e>
    800065ea:	00e4d783          	lhu	a5,14(s1)
    800065ee:	fed795e3          	bne	a5,a3,800065d8 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065f2:	01048913          	addi	s2,s1,16
    800065f6:	854a                	mv	a0,s2
    800065f8:	00001097          	auipc	ra,0x1
    800065fc:	b64080e7          	jalr	-1180(ra) # 8000715c <acquire>
  mbufq_pushtail(&si->rxq, m);
    80006600:	02848493          	addi	s1,s1,40
    80006604:	85d2                	mv	a1,s4
    80006606:	8526                	mv	a0,s1
    80006608:	fffff097          	auipc	ra,0xfffff
    8000660c:	702080e7          	jalr	1794(ra) # 80005d0a <mbufq_pushtail>
  wakeup(&si->rxq);
    80006610:	8526                	mv	a0,s1
    80006612:	ffffb097          	auipc	ra,0xffffb
    80006616:	0d6080e7          	jalr	214(ra) # 800016e8 <wakeup>
  release(&si->lock);
    8000661a:	854a                	mv	a0,s2
    8000661c:	00001097          	auipc	ra,0x1
    80006620:	bf4080e7          	jalr	-1036(ra) # 80007210 <release>
  release(&lock);
    80006624:	00019517          	auipc	a0,0x19
    80006628:	cfc50513          	addi	a0,a0,-772 # 8001f320 <lock>
    8000662c:	00001097          	auipc	ra,0x1
    80006630:	be4080e7          	jalr	-1052(ra) # 80007210 <release>
    80006634:	a831                	j	80006650 <sockrecvudp+0xb6>
  release(&lock);
    80006636:	00019517          	auipc	a0,0x19
    8000663a:	cea50513          	addi	a0,a0,-790 # 8001f320 <lock>
    8000663e:	00001097          	auipc	ra,0x1
    80006642:	bd2080e7          	jalr	-1070(ra) # 80007210 <release>
  mbuffree(m);
    80006646:	8552                	mv	a0,s4
    80006648:	fffff097          	auipc	ra,0xfffff
    8000664c:	6aa080e7          	jalr	1706(ra) # 80005cf2 <mbuffree>
}
...
pci_init()
{
    80006662:	715d                	addi	sp,sp,-80
    80006664:	e486                	sd	ra,72(sp)
    80006666:	e0a2                	sd	s0,64(sp)
    80006668:	fc26                	sd	s1,56(sp)
    8000666a:	f84a                	sd	s2,48(sp)
    8000666c:	f44e                	sd	s3,40(sp)
    8000666e:	f052                	sd	s4,32(sp)
    80006670:	ec56                	sd	s5,24(sp)
    80006672:	e85a                	sd	s6,16(sp)
    80006674:	e45e                	sd	s7,8(sp)
    80006676:	0880                	addi	s0,sp,80
    80006678:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    8000667c:	100e8937          	lui	s2,0x100e8
    80006680:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    80006684:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006686:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006688:	40000b37          	lui	s6,0x40000
    8000668c:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    8000668e:	300409b7          	lui	s3,0x30040
    80006692:	a821                	j	800066aa <pci_init+0x48>
      base[4+0] = e1000_regs;
    80006694:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006698:	40000537          	lui	a0,0x40000
    8000669c:	fffff097          	auipc	ra,0xfffff
    800066a0:	0c4080e7          	jalr	196(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    800066a4:	94d2                	add	s1,s1,s4
    800066a6:	03348a63          	beq	s1,s3,800066da <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    800066aa:	86a6                	mv	a3,s1
    uint32 id = base[0];
    800066ac:	409c                	lw	a5,0(s1)
    800066ae:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    800066b0:	ff279ae3          	bne	a5,s2,800066a4 <pci_init+0x42>
      base[1] = 7;
    800066b4:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    800066b8:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066bc:	01048793          	addi	a5,s1,16
    800066c0:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066c4:	4398                	lw	a4,0(a5)
    800066c6:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066c8:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066cc:	0ff0000f          	fence
        base[4+i] = old;
    800066d0:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066d2:	0791                	addi	a5,a5,4
    800066d4:	fec798e3          	bne	a5,a2,800066c4 <pci_init+0x62>
    800066d8:	bf75                	j	80006694 <pci_init+0x32>
    }
  }
}
    800066da:	60a6                	ld	ra,72(sp)
    800066dc:	6406                	ld	s0,64(sp)
    800066de:	74e2                	ld	s1,56(sp)
    800066e0:	7942                	ld	s2,48(sp)
    800066e2:	79a2                	ld	s3,40(sp)
    800066e4:	7a02                	ld	s4,32(sp)
    800066e6:	6ae2                	ld	s5,24(sp)
    800066e8:	6b42                	ld	s6,16(sp)
    800066ea:	6ba2                	ld	s7,8(sp)
    800066ec:	6161                	addi	sp,sp,80
    800066ee:	8082                	ret

00000000800066f0 <timerinit>:
...
timerinit()
{
    ...
    800066f2:	e422                	sd	s0,8(sp)
    800066f4:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066f6:	f14027f3          	csrr	a5,mhartid
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066fe:	0037979b          	slliw	a5,a5,0x3
    80006702:	02004737          	lui	a4,0x2004
    80006706:	97ba                	add	a5,a5,a4
    80006708:	0200c737          	lui	a4,0x200c
    8000670c:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    80006710:	000f4637          	lui	a2,0xf4
    80006714:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    80006718:	95b2                	add	a1,a1,a2
    8000671a:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    8000671c:	00269713          	slli	a4,a3,0x2
    80006720:	9736                	add	a4,a4,a3
    80006722:	00371693          	slli	a3,a4,0x3
    80006726:	00019717          	auipc	a4,0x19
    8000672a:	c1a70713          	addi	a4,a4,-998 # 8001f340 <timer_scratch>
    8000672e:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    80006730:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    80006732:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    80006734:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    80006738:	fffff797          	auipc	a5,0xfffff
    8000673c:	9c878793          	addi	a5,a5,-1592 # 80005100 <timervec>
...
0000000080006762 <start>:
{
    80006762:	1141                	addi	sp,sp,-16
    80006764:	e406                	sd	ra,8(sp)
    80006766:	e022                	sd	s0,0(sp)
    80006768:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    8000676a:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    8000676e:	7779                	lui	a4,0xffffe
    80006770:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    80006774:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006776:	6705                	lui	a4,0x1
    80006778:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    8000677c:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    8000677e:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    80006782:	ffffa797          	auipc	a5,0xffffa
    80006786:	ba478793          	addi	a5,a5,-1116 # 80000326 <main>
    8000678a:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    8000678e:	4781                	li	a5,0
    80006790:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    80006794:	67c1                	lui	a5,0x10
    80006796:	17fd                	addi	a5,a5,-1
  ...
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    ...
    800067ae:	83a9                	srli	a5,a5,0xa
    800067b0:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    800067b4:	47bd                	li	a5,15
    800067b6:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    800067ba:	00000097          	auipc	ra,0x0
    800067be:	f36080e7          	jalr	-202(ra) # 800066f0 <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800067c2:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    800067c6:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    800067c8:	823e                	mv	tp,a5
  asm volatile("mret");
    800067ca:	30200073          	mret
}
...
{
    800067d6:	715d                	addi	sp,sp,-80
    800067d8:	e486                	sd	ra,72(sp)
    800067da:	e0a2                	sd	s0,64(sp)
    800067dc:	fc26                	sd	s1,56(sp)
    800067de:	f84a                	sd	s2,48(sp)
    800067e0:	f44e                	sd	s3,40(sp)
    800067e2:	f052                	sd	s4,32(sp)
    800067e4:	ec56                	sd	s5,24(sp)
    800067e6:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067e8:	04c05663          	blez	a2,80006834 <consolewrite+0x5e>
    800067ec:	8a2a                	mv	s4,a0
    800067ee:	84ae                	mv	s1,a1
    800067f0:	89b2                	mv	s3,a2
    800067f2:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067f4:	5afd                	li	s5,-1
    800067f6:	4685                	li	a3,1
    800067f8:	8626                	mv	a2,s1
    800067fa:	85d2                	mv	a1,s4
    800067fc:	fbf40513          	addi	a0,s0,-65
    80006800:	ffffb097          	auipc	ra,0xffffb
    80006804:	156080e7          	jalr	342(ra) # 80001956 <either_copyin>
    80006808:	01550c63          	beq	a0,s5,80006820 <consolewrite+0x4a>
      break;
    uartputc(c);
    8000680c:	fbf44503          	lbu	a0,-65(s0)
    80006810:	00000097          	auipc	ra,0x0
    80006814:	78e080e7          	jalr	1934(ra) # 80006f9e <uartputc>
  for(i = 0; i < n; i++){
    80006818:	2905                	addiw	s2,s2,1
    8000681a:	0485                	addi	s1,s1,1
    8000681c:	fd299de3          	bne	s3,s2,800067f6 <consolewrite+0x20>
  }

  return i;
}
    80006820:	854a                	mv	a0,s2
    80006822:	60a6                	ld	ra,72(sp)
    80006824:	6406                	ld	s0,64(sp)
    80006826:	74e2                	ld	s1,56(sp)
    80006828:	7942                	ld	s2,48(sp)
    8000682a:	79a2                	ld	s3,40(sp)
    8000682c:	7a02                	ld	s4,32(sp)
    8000682e:	6ae2                	ld	s5,24(sp)
    80006830:	6161                	addi	sp,sp,80
    80006832:	8082                	ret
  for(i = 0; i < n; i++){
    80006834:	4901                	li	s2,0
    80006836:	b7ed                	j	80006820 <consolewrite+0x4a>

0000000080006838 <consoleread>:
...
{
    80006838:	7119                	addi	sp,sp,-128
    8000683a:	fc86                	sd	ra,120(sp)
    8000683c:	f8a2                	sd	s0,112(sp)
    8000683e:	f4a6                	sd	s1,104(sp)
    80006840:	f0ca                	sd	s2,96(sp)
    80006842:	ecce                	sd	s3,88(sp)
    80006844:	e8d2                	sd	s4,80(sp)
    80006846:	e4d6                	sd	s5,72(sp)
    80006848:	e0da                	sd	s6,64(sp)
    8000684a:	fc5e                	sd	s7,56(sp)
    8000684c:	f862                	sd	s8,48(sp)
    8000684e:	f466                	sd	s9,40(sp)
    80006850:	f06a                	sd	s10,32(sp)
    80006852:	ec6e                	sd	s11,24(sp)
    80006854:	0100                	addi	s0,sp,128
    80006856:	8b2a                	mv	s6,a0
    80006858:	8aae                	mv	s5,a1
    8000685a:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    8000685c:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    80006860:	00021517          	auipc	a0,0x21
    80006864:	c2050513          	addi	a0,a0,-992 # 80027480 <cons>
    80006868:	00001097          	auipc	ra,0x1
    8000686c:	8f4080e7          	jalr	-1804(ra) # 8000715c <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    80006870:	00021497          	auipc	s1,0x21
    80006874:	c1048493          	addi	s1,s1,-1008 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80006878:	89a6                	mv	s3,s1
    8000687a:	00021917          	auipc	s2,0x21
    8000687e:	c9e90913          	addi	s2,s2,-866 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    80006882:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80006886:	4da9                	li	s11,10
  while(n > 0){
    80006888:	07405863          	blez	s4,800068f8 <consoleread+0xc0>
    while(cons.r == cons.w){
    8000688c:	0984a783          	lw	a5,152(s1)
    80006890:	09c4a703          	lw	a4,156(s1)
    80006894:	02f71463          	bne	a4,a5,800068bc <consoleread+0x84>
      if(myproc()->killed){
    80006898:	ffffa097          	auipc	ra,0xffffa
    8000689c:	608080e7          	jalr	1544(ra) # 80000ea0 <myproc>
    800068a0:	551c                	lw	a5,40(a0)
    800068a2:	e7b5                	bnez	a5,8000690e <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    800068a4:	85ce                	mv	a1,s3
    800068a6:	854a                	mv	a0,s2
    800068a8:	ffffb097          	auipc	ra,0xffffb
    800068ac:	cb4080e7          	jalr	-844(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    800068b0:	0984a783          	lw	a5,152(s1)
    800068b4:	09c4a703          	lw	a4,156(s1)
    800068b8:	fef700e3          	beq	a4,a5,80006898 <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    800068bc:	0017871b          	addiw	a4,a5,1
    800068c0:	08e4ac23          	sw	a4,152(s1)
    800068c4:	07f7f713          	andi	a4,a5,127
    800068c8:	9726                	add	a4,a4,s1
    800068ca:	01874703          	lbu	a4,24(a4)
    800068ce:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    800068d2:	079c0663          	beq	s8,s9,8000693e <consoleread+0x106>
    cbuf = c;
    800068d6:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068da:	4685                	li	a3,1
    800068dc:	f8f40613          	addi	a2,s0,-113
    800068e0:	85d6                	mv	a1,s5
    800068e2:	855a                	mv	a0,s6
    800068e4:	ffffb097          	auipc	ra,0xffffb
    800068e8:	01c080e7          	jalr	28(ra) # 80001900 <either_copyout>
    800068ec:	01a50663          	beq	a0,s10,800068f8 <consoleread+0xc0>
    dst++;
    800068f0:	0a85                	addi	s5,s5,1
    --n;
    800068f2:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068f4:	f9bc1ae3          	bne	s8,s11,80006888 <consoleread+0x50>
  ...
  release(&cons.lock);
    ...
    80006904:	910080e7          	jalr	-1776(ra) # 80007210 <release>

  return target - n;
    80006908:	414b853b          	subw	a0,s7,s4
    8000690c:	a811                	j	80006920 <consoleread+0xe8>
        release(&cons.lock);
    8000690e:	00021517          	auipc	a0,0x21
    80006912:	b7250513          	addi	a0,a0,-1166 # 80027480 <cons>
    80006916:	00001097          	auipc	ra,0x1
    8000691a:	8fa080e7          	jalr	-1798(ra) # 80007210 <release>
        return -1;
    8000691e:	557d                	li	a0,-1
}
    80006920:	70e6                	ld	ra,120(sp)
    80006922:	7446                	ld	s0,112(sp)
    80006924:	74a6                	ld	s1,104(sp)
    80006926:	7906                	ld	s2,96(sp)
    80006928:	69e6                	ld	s3,88(sp)
    8000692a:	6a46                	ld	s4,80(sp)
    8000692c:	6aa6                	ld	s5,72(sp)
    8000692e:	6b06                	ld	s6,64(sp)
    80006930:	7be2                	ld	s7,56(sp)
    80006932:	7c42                	ld	s8,48(sp)
    80006934:	7ca2                	ld	s9,40(sp)
    80006936:	7d02                	ld	s10,32(sp)
    80006938:	6de2                	ld	s11,24(sp)
    8000693a:	6109                	addi	sp,sp,128
    8000693c:	8082                	ret
      if(n < target){
    8000693e:	000a071b          	sext.w	a4,s4
    80006942:	fb777be3          	bgeu	a4,s7,800068f8 <consoleread+0xc0>
        cons.r--;
    80006946:	00021717          	auipc	a4,0x21
    8000694a:	bcf72923          	sw	a5,-1070(a4) # 80027518 <cons+0x98>
    8000694e:	b76d                	j	800068f8 <consoleread+0xc0>

0000000080006950 <consputc>:
{
  ...
  if(c == BACKSPACE){
    80006958:	10000793          	li	a5,256
    8000695c:	00f50a63          	beq	a0,a5,80006970 <consputc+0x20>
    uartputc_sync(c);
    80006960:	00000097          	auipc	ra,0x0
    80006964:	564080e7          	jalr	1380(ra) # 80006ec4 <uartputc_sync>
}
    80006968:	60a2                	ld	ra,8(sp)
    8000696a:	6402                	ld	s0,0(sp)
    8000696c:	0141                	addi	sp,sp,16
    8000696e:	8082                	ret
    uartputc_sync('\b'); uartputc_sync(' '); uartputc_sync('\b');
    80006970:	4521                	li	a0,8
    80006972:	00000097          	auipc	ra,0x0
    80006976:	552080e7          	jalr	1362(ra) # 80006ec4 <uartputc_sync>
    8000697a:	02000513          	li	a0,32
    8000697e:	00000097          	auipc	ra,0x0
    80006982:	546080e7          	jalr	1350(ra) # 80006ec4 <uartputc_sync>
    80006986:	4521                	li	a0,8
    80006988:	00000097          	auipc	ra,0x0
    8000698c:	53c080e7          	jalr	1340(ra) # 80006ec4 <uartputc_sync>
    80006990:	bfe1                	j	80006968 <consputc+0x18>

0000000080006992 <consoleintr>:
...
consoleintr(int c)
{
    ...
    8000699a:	e04a                	sd	s2,0(sp)
    8000699c:	1000                	addi	s0,sp,32
    8000699e:	84aa                	mv	s1,a0
  acquire(&cons.lock);
    800069a0:	00021517          	auipc	a0,0x21
    800069a4:	ae050513          	addi	a0,a0,-1312 # 80027480 <cons>
    800069a8:	00000097          	auipc	ra,0x0
    800069ac:	7b4080e7          	jalr	1972(ra) # 8000715c <acquire>

  switch(c){
    800069b0:	47d5                	li	a5,21
    800069b2:	0af48663          	beq	s1,a5,80006a5e <consoleintr+0xcc>
    800069b6:	0297ca63          	blt	a5,s1,800069ea <consoleintr+0x58>
    800069ba:	47a1                	li	a5,8
    800069bc:	0ef48763          	beq	s1,a5,80006aaa <consoleintr+0x118>
    800069c0:	47c1                	li	a5,16
    800069c2:	10f49a63          	bne	s1,a5,80006ad6 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    800069c6:	ffffb097          	auipc	ra,0xffffb
    800069ca:	fe6080e7          	jalr	-26(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    800069ce:	00021517          	auipc	a0,0x21
    800069d2:	ab250513          	addi	a0,a0,-1358 # 80027480 <cons>
    800069d6:	00001097          	auipc	ra,0x1
    800069da:	83a080e7          	jalr	-1990(ra) # 80007210 <release>
}
    800069de:	60e2                	ld	ra,24(sp)
    800069e0:	6442                	ld	s0,16(sp)
    800069e2:	64a2                	ld	s1,8(sp)
    800069e4:	6902                	ld	s2,0(sp)
    800069e6:	6105                	addi	sp,sp,32
    800069e8:	8082                	ret
  switch(c){
    800069ea:	07f00793          	li	a5,127
    800069ee:	0af48e63          	beq	s1,a5,80006aaa <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069f2:	00021717          	auipc	a4,0x21
    800069f6:	a8e70713          	addi	a4,a4,-1394 # 80027480 <cons>
    800069fa:	0a072783          	lw	a5,160(a4)
    800069fe:	09872703          	lw	a4,152(a4)
    80006a02:	9f99                	subw	a5,a5,a4
    80006a04:	07f00713          	li	a4,127
    80006a08:	fcf763e3          	bltu	a4,a5,800069ce <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    80006a0c:	47b5                	li	a5,13
    80006a0e:	0cf48763          	beq	s1,a5,80006adc <consoleintr+0x14a>
      consputc(c);
    80006a12:	8526                	mv	a0,s1
    80006a14:	00000097          	auipc	ra,0x0
    80006a18:	f3c080e7          	jalr	-196(ra) # 80006950 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a1c:	00021797          	auipc	a5,0x21
    80006a20:	a6478793          	addi	a5,a5,-1436 # 80027480 <cons>
    80006a24:	0a07a703          	lw	a4,160(a5)
    80006a28:	0017069b          	addiw	a3,a4,1
    80006a2c:	0006861b          	sext.w	a2,a3
    80006a30:	0ad7a023          	sw	a3,160(a5)
    80006a34:	07f77713          	andi	a4,a4,127
    80006a38:	97ba                	add	a5,a5,a4
    80006a3a:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a3e:	47a9                	li	a5,10
    80006a40:	0cf48563          	beq	s1,a5,80006b0a <consoleintr+0x178>
    80006a44:	4791                	li	a5,4
    80006a46:	0cf48263          	beq	s1,a5,80006b0a <consoleintr+0x178>
    80006a4a:	00021797          	auipc	a5,0x21
    80006a4e:	ace7a783          	lw	a5,-1330(a5) # 80027518 <cons+0x98>
    80006a52:	0807879b          	addiw	a5,a5,128
    80006a56:	f6f61ce3          	bne	a2,a5,800069ce <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a5a:	863e                	mv	a2,a5
    80006a5c:	a07d                	j	80006b0a <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a5e:	00021717          	auipc	a4,0x21
    80006a62:	a2270713          	addi	a4,a4,-1502 # 80027480 <cons>
    80006a66:	0a072783          	lw	a5,160(a4)
    80006a6a:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a6e:	00021497          	auipc	s1,0x21
    80006a72:	a1248493          	addi	s1,s1,-1518 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a76:	4929                	li	s2,10
    80006a78:	f4f70be3          	beq	a4,a5,800069ce <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a7c:	37fd                	addiw	a5,a5,-1
    80006a7e:	07f7f713          	andi	a4,a5,127
    80006a82:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a84:	01874703          	lbu	a4,24(a4)
    80006a88:	f52703e3          	beq	a4,s2,800069ce <consoleintr+0x3c>
      cons.e--;
    80006a8c:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a90:	10000513          	li	a0,256
    80006a94:	00000097          	auipc	ra,0x0
    80006a98:	ebc080e7          	jalr	-324(ra) # 80006950 <consputc>
    while(cons.e != cons.w &&
    80006a9c:	0a04a783          	lw	a5,160(s1)
    80006aa0:	09c4a703          	lw	a4,156(s1)
    80006aa4:	fcf71ce3          	bne	a4,a5,80006a7c <consoleintr+0xea>
    80006aa8:	b71d                	j	800069ce <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006aaa:	00021717          	auipc	a4,0x21
    80006aae:	9d670713          	addi	a4,a4,-1578 # 80027480 <cons>
    80006ab2:	0a072783          	lw	a5,160(a4)
    80006ab6:	09c72703          	lw	a4,156(a4)
    80006aba:	f0f70ae3          	beq	a4,a5,800069ce <consoleintr+0x3c>
      cons.e--;
    80006abe:	37fd                	addiw	a5,a5,-1
    80006ac0:	00021717          	auipc	a4,0x21
    80006ac4:	a6f72023          	sw	a5,-1440(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006ac8:	10000513          	li	a0,256
    80006acc:	00000097          	auipc	ra,0x0
    80006ad0:	e84080e7          	jalr	-380(ra) # 80006950 <consputc>
    80006ad4:	bded                	j	800069ce <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006ad6:	ee048ce3          	beqz	s1,800069ce <consoleintr+0x3c>
    80006ada:	bf21                	j	800069f2 <consoleintr+0x60>
      consputc(c);
    80006adc:	4529                	li	a0,10
    80006ade:	00000097          	auipc	ra,0x0
    80006ae2:	e72080e7          	jalr	-398(ra) # 80006950 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006ae6:	00021797          	auipc	a5,0x21
    80006aea:	99a78793          	addi	a5,a5,-1638 # 80027480 <cons>
    80006aee:	0a07a703          	lw	a4,160(a5)
    80006af2:	0017069b          	addiw	a3,a4,1
    80006af6:	0006861b          	sext.w	a2,a3
    80006afa:	0ad7a023          	sw	a3,160(a5)
    80006afe:	07f77713          	andi	a4,a4,127
    80006b02:	97ba                	add	a5,a5,a4
    80006b04:	4729                	li	a4,10
    80006b06:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006b0a:	00021797          	auipc	a5,0x21
    80006b0e:	a0c7a923          	sw	a2,-1518(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006b12:	00021517          	auipc	a0,0x21
    80006b16:	a0650513          	addi	a0,a0,-1530 # 80027518 <cons+0x98>
    80006b1a:	ffffb097          	auipc	ra,0xffffb
    80006b1e:	bce080e7          	jalr	-1074(ra) # 800016e8 <wakeup>
    80006b22:	b575                	j	800069ce <consoleintr+0x3c>

0000000080006b24 <consoleinit>:

void
consoleinit(void)
{
    80006b24:	1141                	addi	sp,sp,-16
    80006b26:	e406                	sd	ra,8(sp)
    80006b28:	e022                	sd	s0,0(sp)
    80006b2a:	0800                	addi	s0,sp,16
  initlock(&cons.lock, "cons");
    80006b2c:	00003597          	auipc	a1,0x3
    80006b30:	cfc58593          	addi	a1,a1,-772 # 80009828 <syscalls+0x450>
    80006b34:	00021517          	auipc	a0,0x21
    80006b38:	94c50513          	addi	a0,a0,-1716 # 80027480 <cons>
    80006b3c:	00000097          	auipc	ra,0x0
    80006b40:	590080e7          	jalr	1424(ra) # 800070cc <initlock>

  uartinit();
    80006b44:	00000097          	auipc	ra,0x0
    80006b48:	330080e7          	jalr	816(ra) # 80006e74 <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b4c:	00013797          	auipc	a5,0x13
    80006b50:	59c78793          	addi	a5,a5,1436 # 8001a0e8 <devsw>
    80006b54:	00000717          	auipc	a4,0x0
    80006b58:	ce470713          	addi	a4,a4,-796 # 80006838 <consoleread>
    80006b5c:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b5e:	00000717          	auipc	a4,0x0
    80006b62:	c7870713          	addi	a4,a4,-904 # 800067d6 <consolewrite>
    80006b66:	ef98                	sd	a4,24(a5)
}
    80006b68:	60a2                	ld	ra,8(sp)
    80006b6a:	6402                	ld	s0,0(sp)
    80006b6c:	0141                	addi	sp,sp,16
    80006b6e:	8082                	ret

0000000080006b70 <printint>:
...
printint(int xx, int base, int sign)
{
    ...
    80006b7a:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b7c:	c219                	beqz	a2,80006b82 <printint+0x12>
    80006b7e:	08054663          	bltz	a0,80006c0a <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b82:	2501                	sext.w	a0,a0
    80006b84:	4881                	li	a7,0
    80006b86:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b8a:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b8c:	2581                	sext.w	a1,a1
    80006b8e:	00003617          	auipc	a2,0x3
    80006b92:	cca60613          	addi	a2,a2,-822 # 80009858 <digits>
    80006b96:	883a                	mv	a6,a4
    80006b98:	2705                	addiw	a4,a4,1
    80006b9a:	02b577bb          	remuw	a5,a0,a1
    80006b9e:	1782                	slli	a5,a5,0x20
    80006ba0:	9381                	srli	a5,a5,0x20
    80006ba2:	97b2                	add	a5,a5,a2
    80006ba4:	0007c783          	lbu	a5,0(a5)
    80006ba8:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006bac:	0005079b          	sext.w	a5,a0
    80006bb0:	02b5553b          	divuw	a0,a0,a1
    80006bb4:	0685                	addi	a3,a3,1
    80006bb6:	feb7f0e3          	bgeu	a5,a1,80006b96 <printint+0x26>

  if(sign)
    80006bba:	00088b63          	beqz	a7,80006bd0 <printint+0x60>
    buf[i++] = '-';
    80006bbe:	fe040793          	addi	a5,s0,-32
    80006bc2:	973e                	add	a4,a4,a5
    80006bc4:	02d00793          	li	a5,45
    80006bc8:	fef70823          	sb	a5,-16(a4)
    80006bcc:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006bd0:	02e05763          	blez	a4,80006bfe <printint+0x8e>
    80006bd4:	fd040793          	addi	a5,s0,-48
    80006bd8:	00e784b3          	add	s1,a5,a4
    80006bdc:	fff78913          	addi	s2,a5,-1
    80006be0:	993a                	add	s2,s2,a4
    80006be2:	377d                	addiw	a4,a4,-1
    80006be4:	1702                	slli	a4,a4,0x20
    80006be6:	9301                	srli	a4,a4,0x20
    80006be8:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006bec:	fff4c503          	lbu	a0,-1(s1)
    80006bf0:	00000097          	auipc	ra,0x0
    80006bf4:	d60080e7          	jalr	-672(ra) # 80006950 <consputc>
  while(--i >= 0)
    80006bf8:	14fd                	addi	s1,s1,-1
    80006bfa:	ff2499e3          	bne	s1,s2,80006bec <printint+0x7c>
}
    80006bfe:	70a2                	ld	ra,40(sp)
    80006c00:	7402                	ld	s0,32(sp)
    80006c02:	64e2                	ld	s1,24(sp)
    80006c04:	6942                	ld	s2,16(sp)
    80006c06:	6145                	addi	sp,sp,48
    80006c08:	8082                	ret
    x = -xx;
    80006c0a:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006c0e:	4885                	li	a7,1
    x = -xx;
    80006c10:	bf9d                	j	80006b86 <printint+0x16>

0000000080006c12 <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    ...
    80006c14:	ec06                	sd	ra,24(sp)
    80006c16:	e822                	sd	s0,16(sp)
    80006c18:	e426                	sd	s1,8(sp)
    80006c1a:	1000                	addi	s0,sp,32
    80006c1c:	84aa                	mv	s1,a0
  pr.locking = 0;
    80006c1e:	00021797          	auipc	a5,0x21
    80006c22:	9207a123          	sw	zero,-1758(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006c26:	00003517          	auipc	a0,0x3
    80006c2a:	c0a50513          	addi	a0,a0,-1014 # 80009830 <syscalls+0x458>
    80006c2e:	00000097          	auipc	ra,0x0
    80006c32:	02e080e7          	jalr	46(ra) # 80006c5c <printf>
  printf(s);
    80006c36:	8526                	mv	a0,s1
    80006c38:	00000097          	auipc	ra,0x0
    80006c3c:	024080e7          	jalr	36(ra) # 80006c5c <printf>
  printf("\n");
    80006c40:	00002517          	auipc	a0,0x2
    80006c44:	40850513          	addi	a0,a0,1032 # 80009048 <etext+0x48>
    80006c48:	00000097          	auipc	ra,0x0
    80006c4c:	014080e7          	jalr	20(ra) # 80006c5c <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c50:	4785                	li	a5,1
    80006c52:	00003717          	auipc	a4,0x3
    80006c56:	3cf72f23          	sw	a5,990(a4) # 8000a030 <panicked>
  for(;;)
    80006c5a:	a001                	j	80006c5a <panic+0x48>

0000000080006c5c <printf>:
{
    80006c5c:	7131                	addi	sp,sp,-192
    80006c5e:	fc86                	sd	ra,120(sp)
    80006c60:	f8a2                	sd	s0,112(sp)
    80006c62:	f4a6                	sd	s1,104(sp)
    80006c64:	f0ca                	sd	s2,96(sp)
    80006c66:	ecce                	sd	s3,88(sp)
    80006c68:	e8d2                	sd	s4,80(sp)
    80006c6a:	e4d6                	sd	s5,72(sp)
    80006c6c:	e0da                	sd	s6,64(sp)
    80006c6e:	fc5e                	sd	s7,56(sp)
    80006c70:	f862                	sd	s8,48(sp)
    80006c72:	f466                	sd	s9,40(sp)
    80006c74:	f06a                	sd	s10,32(sp)
    80006c76:	ec6e                	sd	s11,24(sp)
    80006c78:	0100                	addi	s0,sp,128
    80006c7a:	8a2a                	mv	s4,a0
    80006c7c:	e40c                	sd	a1,8(s0)
    80006c7e:	e810                	sd	a2,16(s0)
    80006c80:	ec14                	sd	a3,24(s0)
    80006c82:	f018                	sd	a4,32(s0)
    80006c84:	f41c                	sd	a5,40(s0)
    80006c86:	03043823          	sd	a6,48(s0)
    80006c8a:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c8e:	00021d97          	auipc	s11,0x21
    80006c92:	8b2dad83          	lw	s11,-1870(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c96:	020d9b63          	bnez	s11,80006ccc <printf+0x70>
  if (fmt == 0)
    80006c9a:	040a0263          	beqz	s4,80006cde <printf+0x82>
  va_start(ap, fmt);
    80006c9e:	00840793          	addi	a5,s0,8
    80006ca2:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006ca6:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006caa:	16050263          	beqz	a0,80006e0e <printf+0x1b2>
    80006cae:	4481                	li	s1,0
    if(c != '%'){
    80006cb0:	02500a93          	li	s5,37
    switch(c){
    80006cb4:	07000b13          	li	s6,112
  consputc('x');
    80006cb8:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006cba:	00003b97          	auipc	s7,0x3
    80006cbe:	b9eb8b93          	addi	s7,s7,-1122 # 80009858 <digits>
    switch(c){
    80006cc2:	07300c93          	li	s9,115
    80006cc6:	06400c13          	li	s8,100
    80006cca:	a82d                	j	80006d04 <printf+0xa8>
    acquire(&pr.lock);
    80006ccc:	00021517          	auipc	a0,0x21
    80006cd0:	85c50513          	addi	a0,a0,-1956 # 80027528 <pr>
    80006cd4:	00000097          	auipc	ra,0x0
    80006cd8:	488080e7          	jalr	1160(ra) # 8000715c <acquire>
    80006cdc:	bf7d                	j	80006c9a <printf+0x3e>
    panic("null fmt");
    80006cde:	00003517          	auipc	a0,0x3
    80006ce2:	b6250513          	addi	a0,a0,-1182 # 80009840 <syscalls+0x468>
    80006ce6:	00000097          	auipc	ra,0x0
    80006cea:	f2c080e7          	jalr	-212(ra) # 80006c12 <panic>
      consputc(c);
    80006cee:	00000097          	auipc	ra,0x0
    80006cf2:	c62080e7          	jalr	-926(ra) # 80006950 <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cf6:	2485                	addiw	s1,s1,1
    80006cf8:	009a07b3          	add	a5,s4,s1
    80006cfc:	0007c503          	lbu	a0,0(a5)
    80006d00:	10050763          	beqz	a0,80006e0e <printf+0x1b2>
    if(c != '%'){
    80006d04:	ff5515e3          	bne	a0,s5,80006cee <printf+0x92>
    c = fmt[++i] & 0xff;
    80006d08:	2485                	addiw	s1,s1,1
    80006d0a:	009a07b3          	add	a5,s4,s1
    80006d0e:	0007c783          	lbu	a5,0(a5)
    80006d12:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006d16:	cfe5                	beqz	a5,80006e0e <printf+0x1b2>
    switch(c){
    80006d18:	05678a63          	beq	a5,s6,80006d6c <printf+0x110>
    80006d1c:	02fb7663          	bgeu	s6,a5,80006d48 <printf+0xec>
    80006d20:	09978963          	beq	a5,s9,80006db2 <printf+0x156>
    80006d24:	07800713          	li	a4,120
    80006d28:	0ce79863          	bne	a5,a4,80006df8 <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006d2c:	f8843783          	ld	a5,-120(s0)
    80006d30:	00878713          	addi	a4,a5,8
    80006d34:	f8e43423          	sd	a4,-120(s0)
    80006d38:	4605                	li	a2,1
    80006d3a:	85ea                	mv	a1,s10
    80006d3c:	4388                	lw	a0,0(a5)
    80006d3e:	00000097          	auipc	ra,0x0
    80006d42:	e32080e7          	jalr	-462(ra) # 80006b70 <printint>
      break;
    80006d46:	bf45                	j	80006cf6 <printf+0x9a>
    switch(c){
    80006d48:	0b578263          	beq	a5,s5,80006dec <printf+0x190>
    80006d4c:	0b879663          	bne	a5,s8,80006df8 <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d50:	f8843783          	ld	a5,-120(s0)
    80006d54:	00878713          	addi	a4,a5,8
    80006d58:	f8e43423          	sd	a4,-120(s0)
    80006d5c:	4605                	li	a2,1
    80006d5e:	45a9                	li	a1,10
    80006d60:	4388                	lw	a0,0(a5)
    80006d62:	00000097          	auipc	ra,0x0
    80006d66:	e0e080e7          	jalr	-498(ra) # 80006b70 <printint>
      break;
    80006d6a:	b771                	j	80006cf6 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d6c:	f8843783          	ld	a5,-120(s0)
    80006d70:	00878713          	addi	a4,a5,8
    80006d74:	f8e43423          	sd	a4,-120(s0)
    80006d78:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d7c:	03000513          	li	a0,48
    80006d80:	00000097          	auipc	ra,0x0
    80006d84:	bd0080e7          	jalr	-1072(ra) # 80006950 <consputc>
  consputc('x');
    80006d88:	07800513          	li	a0,120
    80006d8c:	00000097          	auipc	ra,0x0
    80006d90:	bc4080e7          	jalr	-1084(ra) # 80006950 <consputc>
    80006d94:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d96:	03c9d793          	srli	a5,s3,0x3c
    80006d9a:	97de                	add	a5,a5,s7
    80006d9c:	0007c503          	lbu	a0,0(a5)
    80006da0:	00000097          	auipc	ra,0x0
    80006da4:	bb0080e7          	jalr	-1104(ra) # 80006950 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006da8:	0992                	slli	s3,s3,0x4
    80006daa:	397d                	addiw	s2,s2,-1
    80006dac:	fe0915e3          	bnez	s2,80006d96 <printf+0x13a>
    80006db0:	b799                	j	80006cf6 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006db2:	f8843783          	ld	a5,-120(s0)
    80006db6:	00878713          	addi	a4,a5,8
    80006dba:	f8e43423          	sd	a4,-120(s0)
    80006dbe:	0007b903          	ld	s2,0(a5)
    80006dc2:	00090e63          	beqz	s2,80006dde <printf+0x182>
      for(; *s; s++)
    80006dc6:	00094503          	lbu	a0,0(s2)
    80006dca:	d515                	beqz	a0,80006cf6 <printf+0x9a>
        consputc(*s);
    80006dcc:	00000097          	auipc	ra,0x0
    80006dd0:	b84080e7          	jalr	-1148(ra) # 80006950 <consputc>
      for(; *s; s++)
    80006dd4:	0905                	addi	s2,s2,1
    80006dd6:	00094503          	lbu	a0,0(s2)
    80006dda:	f96d                	bnez	a0,80006dcc <printf+0x170>
    80006ddc:	bf29                	j	80006cf6 <printf+0x9a>
        s = "(null)";
    80006dde:	00003917          	auipc	s2,0x3
    80006de2:	a5a90913          	addi	s2,s2,-1446 # 80009838 <syscalls+0x460>
      for(; *s; s++)
    80006de6:	02800513          	li	a0,40
    80006dea:	b7cd                	j	80006dcc <printf+0x170>
      consputc('%');
    80006dec:	8556                	mv	a0,s5
    80006dee:	00000097          	auipc	ra,0x0
    80006df2:	b62080e7          	jalr	-1182(ra) # 80006950 <consputc>
      break;
    80006df6:	b701                	j	80006cf6 <printf+0x9a>
      consputc('%');
    80006df8:	8556                	mv	a0,s5
    80006dfa:	00000097          	auipc	ra,0x0
    80006dfe:	b56080e7          	jalr	-1194(ra) # 80006950 <consputc>
      consputc(c);
    80006e02:	854a                	mv	a0,s2
    80006e04:	00000097          	auipc	ra,0x0
    80006e08:	b4c080e7          	jalr	-1204(ra) # 80006950 <consputc>
      break;
    80006e0c:	b5ed                	j	80006cf6 <printf+0x9a>
  if(locking)
    80006e0e:	020d9163          	bnez	s11,80006e30 <printf+0x1d4>
}
    80006e12:	70e6                	ld	ra,120(sp)
    80006e14:	7446                	ld	s0,112(sp)
    80006e16:	74a6                	ld	s1,104(sp)
    80006e18:	7906                	ld	s2,96(sp)
    80006e1a:	69e6                	ld	s3,88(sp)
    80006e1c:	6a46                	ld	s4,80(sp)
    80006e1e:	6aa6                	ld	s5,72(sp)
    80006e20:	6b06                	ld	s6,64(sp)
    80006e22:	7be2                	ld	s7,56(sp)
    80006e24:	7c42                	ld	s8,48(sp)
    80006e26:	7ca2                	ld	s9,40(sp)
    80006e28:	7d02                	ld	s10,32(sp)
    80006e2a:	6de2                	ld	s11,24(sp)
    80006e2c:	6129                	addi	sp,sp,192
    80006e2e:	8082                	ret
    release(&pr.lock);
    80006e30:	00020517          	auipc	a0,0x20
    80006e34:	6f850513          	addi	a0,a0,1784 # 80027528 <pr>
    80006e38:	00000097          	auipc	ra,0x0
    80006e3c:	3d8080e7          	jalr	984(ra) # 80007210 <release>
}
    80006e40:	bfc9                	j	80006e12 <printf+0x1b6>

0000000080006e42 <printfinit>:
    ;
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80006e4c:	00020497          	auipc	s1,0x20
    80006e50:	6dc48493          	addi	s1,s1,1756 # 80027528 <pr>
    80006e54:	00003597          	auipc	a1,0x3
    80006e58:	9fc58593          	addi	a1,a1,-1540 # 80009850 <syscalls+0x478>
    80006e5c:	8526                	mv	a0,s1
    80006e5e:	00000097          	auipc	ra,0x0
    80006e62:	26e080e7          	jalr	622(ra) # 800070cc <initlock>
  pr.locking = 1;
    80006e66:	4785                	li	a5,1
    80006e68:	cc9c                	sw	a5,24(s1)
}
    80006e6a:	60e2                	ld	ra,24(sp)
    80006e6c:	6442                	ld	s0,16(sp)
    80006e6e:	64a2                	ld	s1,8(sp)
    80006e70:	6105                	addi	sp,sp,32
    80006e72:	8082                	ret

0000000080006e74 <uartinit>:
...
uartinit(void)
{
    80006e74:	1141                	addi	sp,sp,-16
    80006e76:	e406                	sd	ra,8(sp)
    80006e78:	e022                	sd	s0,0(sp)
    80006e7a:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e7c:	100007b7          	lui	a5,0x10000
    80006e80:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e84:	f8000713          	li	a4,-128
    80006e88:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e8c:	470d                	li	a4,3
    80006e8e:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e92:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e96:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e9a:	469d                	li	a3,7
    80006e9c:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006ea0:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006ea4:	00003597          	auipc	a1,0x3
    80006ea8:	9cc58593          	addi	a1,a1,-1588 # 80009870 <digits+0x18>
    80006eac:	00020517          	auipc	a0,0x20
    80006eb0:	69c50513          	addi	a0,a0,1692 # 80027548 <uart_tx_lock>
    80006eb4:	00000097          	auipc	ra,0x0
    80006eb8:	218080e7          	jalr	536(ra) # 800070cc <initlock>
}
    80006ebc:	60a2                	ld	ra,8(sp)
    80006ebe:	6402                	ld	s0,0(sp)
    80006ec0:	0141                	addi	sp,sp,16
    80006ec2:	8082                	ret

0000000080006ec4 <uartputc_sync>:
...
uartputc_sync(int c)
{
    ...
    80006ecc:	1000                	addi	s0,sp,32
    80006ece:	84aa                	mv	s1,a0
  push_off();
    80006ed0:	00000097          	auipc	ra,0x0
    80006ed4:	240080e7          	jalr	576(ra) # 80007110 <push_off>

  if(panicked){
    80006ed8:	00003797          	auipc	a5,0x3
    80006edc:	1587a783          	lw	a5,344(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  if(panicked){
    80006ee4:	c391                	beqz	a5,80006ee8 <uartputc_sync+0x24>
    for(;;)
    80006ee6:	a001                	j	80006ee6 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ee8:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006eec:	0ff7f793          	andi	a5,a5,255
    80006ef0:	0207f793          	andi	a5,a5,32
    80006ef4:	dbf5                	beqz	a5,80006ee8 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006ef6:	0ff4f793          	andi	a5,s1,255
    80006efa:	10000737          	lui	a4,0x10000
    80006efe:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006f02:	00000097          	auipc	ra,0x0
    80006f06:	2ae080e7          	jalr	686(ra) # 800071b0 <pop_off>
}
    80006f0a:	60e2                	ld	ra,24(sp)
    80006f0c:	6442                	ld	s0,16(sp)
    80006f0e:	64a2                	ld	s1,8(sp)
    80006f10:	6105                	addi	sp,sp,32
    80006f12:	8082                	ret

0000000080006f14 <uartstart>:
...
uartstart()
{
  while(1){
    ...
    80006f14:	00003717          	auipc	a4,0x3
    80006f18:	12473703          	ld	a4,292(a4) # 8000a038 <uart_tx_r>
    80006f1c:	00003797          	auipc	a5,0x3
    80006f20:	1247b783          	ld	a5,292(a5) # 8000a040 <uart_tx_w>
    80006f24:	06e78c63          	beq	a5,a4,80006f9c <uartstart+0x88>
{
    ...
    80006f3a:	10000937          	lui	s2,0x10000
    ...
    80006f3e:	00020a17          	auipc	s4,0x20
    80006f42:	60aa0a13          	addi	s4,s4,1546 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f46:	00003497          	auipc	s1,0x3
    80006f4a:	0f248493          	addi	s1,s1,242 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f4e:	00003997          	auipc	s3,0x3
    80006f52:	0f298993          	addi	s3,s3,242 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f56:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f5a:	0ff7f793          	andi	a5,a5,255
    80006f5e:	0207f793          	andi	a5,a5,32
    80006f62:	c785                	beqz	a5,80006f8a <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f64:	01f77793          	andi	a5,a4,31
    80006f68:	97d2                	add	a5,a5,s4
    80006f6a:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f6e:	0705                	addi	a4,a4,1
    80006f70:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f72:	8526                	mv	a0,s1
    80006f74:	ffffa097          	auipc	ra,0xffffa
    80006f78:	774080e7          	jalr	1908(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f7c:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f80:	6098                	ld	a4,0(s1)
    80006f82:	0009b783          	ld	a5,0(s3)
    80006f86:	fce798e3          	bne	a5,a4,80006f56 <uartstart+0x42>
  }
}
    80006f8a:	70e2                	ld	ra,56(sp)
    80006f8c:	7442                	ld	s0,48(sp)
    80006f8e:	74a2                	ld	s1,40(sp)
    80006f90:	7902                	ld	s2,32(sp)
    80006f92:	69e2                	ld	s3,24(sp)
    80006f94:	6a42                	ld	s4,16(sp)
    80006f96:	6aa2                	ld	s5,8(sp)
    80006f98:	6121                	addi	sp,sp,64
    80006f9a:	8082                	ret
    80006f9c:	8082                	ret

0000000080006f9e <uartputc>:
{
    ...
    80006faa:	e052                	sd	s4,0(sp)
    80006fac:	1800                	addi	s0,sp,48
    80006fae:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006fb0:	00020517          	auipc	a0,0x20
    80006fb4:	59850513          	addi	a0,a0,1432 # 80027548 <uart_tx_lock>
    80006fb8:	00000097          	auipc	ra,0x0
    80006fbc:	1a4080e7          	jalr	420(ra) # 8000715c <acquire>
  if(panicked){
    80006fc0:	00003797          	auipc	a5,0x3
    80006fc4:	0707a783          	lw	a5,112(a5) # 8000a030 <panicked>
    80006fc8:	c391                	beqz	a5,80006fcc <uartputc+0x2e>
    for(;;)
    80006fca:	a001                	j	80006fca <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fcc:	00003797          	auipc	a5,0x3
    80006fd0:	0747b783          	ld	a5,116(a5) # 8000a040 <uart_tx_w>
    80006fd4:	00003717          	auipc	a4,0x3
    80006fd8:	06473703          	ld	a4,100(a4) # 8000a038 <uart_tx_r>
    80006fdc:	02070713          	addi	a4,a4,32
    80006fe0:	02f71b63          	bne	a4,a5,80007016 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fe4:	00020a17          	auipc	s4,0x20
    80006fe8:	564a0a13          	addi	s4,s4,1380 # 80027548 <uart_tx_lock>
    80006fec:	00003497          	auipc	s1,0x3
    80006ff0:	04c48493          	addi	s1,s1,76 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006ff4:	00003917          	auipc	s2,0x3
    80006ff8:	04c90913          	addi	s2,s2,76 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006ffc:	85d2                	mv	a1,s4
    80006ffe:	8526                	mv	a0,s1
    80007000:	ffffa097          	auipc	ra,0xffffa
    80007004:	55c080e7          	jalr	1372(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80007008:	00093783          	ld	a5,0(s2)
    8000700c:	6098                	ld	a4,0(s1)
    8000700e:	02070713          	addi	a4,a4,32
    80007012:	fef705e3          	beq	a4,a5,80006ffc <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80007016:	00020497          	auipc	s1,0x20
    8000701a:	53248493          	addi	s1,s1,1330 # 80027548 <uart_tx_lock>
    8000701e:	01f7f713          	andi	a4,a5,31
    80007022:	9726                	add	a4,a4,s1
    80007024:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    80007028:	0785                	addi	a5,a5,1
    8000702a:	00003717          	auipc	a4,0x3
    8000702e:	00f73b23          	sd	a5,22(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80007032:	00000097          	auipc	ra,0x0
    80007036:	ee2080e7          	jalr	-286(ra) # 80006f14 <uartstart>
      release(&uart_tx_lock);
    8000703a:	8526                	mv	a0,s1
    8000703c:	00000097          	auipc	ra,0x0
    80007040:	1d4080e7          	jalr	468(ra) # 80007210 <release>
}
    80007044:	70a2                	ld	ra,40(sp)
    80007046:	7402                	ld	s0,32(sp)
    80007048:	64e2                	ld	s1,24(sp)
    8000704a:	6942                	ld	s2,16(sp)
    8000704c:	69a2                	ld	s3,8(sp)
    8000704e:	6a02                	ld	s4,0(sp)
    80007050:	6145                	addi	sp,sp,48
    80007052:	8082                	ret

0000000080007054 <uartgetc>:
...
uartgetc(void)
{
    80007054:	1141                	addi	sp,sp,-16
    80007056:	e422                	sd	s0,8(sp)
    80007058:	0800                	addi	s0,sp,16
  if(ReadReg(LSR) & 0x01){
    8000705a:	100007b7          	lui	a5,0x10000
    8000705e:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    80007062:	8b85                	andi	a5,a5,1
    80007064:	cb91                	beqz	a5,80007078 <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    80007066:	100007b7          	lui	a5,0x10000
    8000706a:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    8000706e:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    ...
    80007076:	8082                	ret
    return -1;
    80007078:	557d                	li	a0,-1
    8000707a:	bfe5                	j	80007072 <uartgetc+0x1e>

000000008000707c <uartintr>:
...
uartintr(void)
{
    8000707c:	1101                	addi	sp,sp,-32
    8000707e:	ec06                	sd	ra,24(sp)
    80007080:	e822                	sd	s0,16(sp)
    80007082:	e426                	sd	s1,8(sp)
    80007084:	1000                	addi	s0,sp,32
  // read and process incoming characters.
  while(1){
    int c = uartgetc();
    if(c == -1)
    80007086:	54fd                	li	s1,-1
    int c = uartgetc();
    80007088:	00000097          	auipc	ra,0x0
    8000708c:	fcc080e7          	jalr	-52(ra) # 80007054 <uartgetc>
    if(c == -1)
    80007090:	00950763          	beq	a0,s1,8000709e <uartintr+0x22>
      break;
    consoleintr(c);
    80007094:	00000097          	auipc	ra,0x0
    80007098:	8fe080e7          	jalr	-1794(ra) # 80006992 <consoleintr>
  while(1){
    8000709c:	b7f5                	j	80007088 <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    8000709e:	00020497          	auipc	s1,0x20
    800070a2:	4aa48493          	addi	s1,s1,1194 # 80027548 <uart_tx_lock>
    800070a6:	8526                	mv	a0,s1
    800070a8:	00000097          	auipc	ra,0x0
    800070ac:	0b4080e7          	jalr	180(ra) # 8000715c <acquire>
  uartstart();
    800070b0:	00000097          	auipc	ra,0x0
    800070b4:	e64080e7          	jalr	-412(ra) # 80006f14 <uartstart>
  release(&uart_tx_lock);
    800070b8:	8526                	mv	a0,s1
    800070ba:	00000097          	auipc	ra,0x0
    800070be:	156080e7          	jalr	342(ra) # 80007210 <release>
}
    800070c2:	60e2                	ld	ra,24(sp)
    800070c4:	6442                	ld	s0,16(sp)
    800070c6:	64a2                	ld	s1,8(sp)
    800070c8:	6105                	addi	sp,sp,32
    800070ca:	8082                	ret

00000000800070cc <initlock>:
}
#endif
...
initlock(struct spinlock *lk, char *name)
{
  ...
  lk->name = name;
    800070d2:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070d4:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070d8:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
    ...
    800070dc:	6422                	ld	s0,8(sp)
    800070de:	0141                	addi	sp,sp,16
    800070e0:	8082                	ret

00000000800070e2 <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070e2:	411c                	lw	a5,0(a0)
    800070e4:	e399                	bnez	a5,800070ea <holding+0x8>
    800070e6:	4501                	li	a0,0
  return r;
}
    800070e8:	8082                	ret
{
    800070ea:	1101                	addi	sp,sp,-32
    800070ec:	ec06                	sd	ra,24(sp)
    800070ee:	e822                	sd	s0,16(sp)
    800070f0:	e426                	sd	s1,8(sp)
    800070f2:	1000                	addi	s0,sp,32
  r = (lk->locked && lk->cpu == mycpu());
    800070f4:	6904                	ld	s1,16(a0)
    800070f6:	ffffa097          	auipc	ra,0xffffa
    800070fa:	d8e080e7          	jalr	-626(ra) # 80000e84 <mycpu>
    800070fe:	40a48533          	sub	a0,s1,a0
    80007102:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
    80007110:	1101                	addi	sp,sp,-32
    80007112:	ec06                	sd	ra,24(sp)
    80007114:	e822                	sd	s0,16(sp)
    80007116:	e426                	sd	s1,8(sp)
    80007118:	1000                	addi	s0,sp,32
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    8000711a:	100024f3          	csrr	s1,sstatus
    8000711e:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80007122:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
  ...
  if(mycpu()->noff == 0)
    ...
    8000712c:	d5c080e7          	jalr	-676(ra) # 80000e84 <mycpu>
    80007130:	5d3c                	lw	a5,120(a0)
    80007132:	cf89                	beqz	a5,8000714c <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    80007134:	ffffa097          	auipc	ra,0xffffa
    80007138:	d50080e7          	jalr	-688(ra) # 80000e84 <mycpu>
    8000713c:	5d3c                	lw	a5,120(a0)
    8000713e:	2785                	addiw	a5,a5,1
    80007140:	dd3c                	sw	a5,120(a0)
}
    ...
    80007150:	d38080e7          	jalr	-712(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    80007154:	8085                	srli	s1,s1,0x1
    80007156:	8885                	andi	s1,s1,1
    80007158:	dd64                	sw	s1,124(a0)
    8000715a:	bfe9                	j	80007134 <push_off+0x24>

000000008000715c <acquire>:
{
  ...
  push_off(); // disable interrupts to avoid deadlock.
    ...
    8000716c:	fa8080e7          	jalr	-88(ra) # 80007110 <push_off>
  if(holding(lk))
    80007170:	8526                	mv	a0,s1
    80007172:	00000097          	auipc	ra,0x0
    80007176:	f70080e7          	jalr	-144(ra) # 800070e2 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    8000717a:	4705                	li	a4,1
  if(holding(lk))
    8000717c:	e115                	bnez	a0,800071a0 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    8000717e:	87ba                	mv	a5,a4
    80007180:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    80007184:	2781                	sext.w	a5,a5
    80007186:	ffe5                	bnez	a5,8000717e <acquire+0x22>
  __sync_synchronize();
    80007188:	0ff0000f          	fence
  lk->cpu = mycpu();
    8000718c:	ffffa097          	auipc	ra,0xffffa
    80007190:	cf8080e7          	jalr	-776(ra) # 80000e84 <mycpu>
    80007194:	e888                	sd	a0,16(s1)
}
    80007196:	60e2                	ld	ra,24(sp)
    80007198:	6442                	ld	s0,16(sp)
    8000719a:	64a2                	ld	s1,8(sp)
    8000719c:	6105                	addi	sp,sp,32
    8000719e:	8082                	ret
    panic("acquire");
    800071a0:	00002517          	auipc	a0,0x2
    800071a4:	6d850513          	addi	a0,a0,1752 # 80009878 <digits+0x20>
    800071a8:	00000097          	auipc	ra,0x0
    800071ac:	a6a080e7          	jalr	-1430(ra) # 80006c12 <panic>

00000000800071b0 <pop_off>:

void
pop_off(void)
{
    800071b0:	1141                	addi	sp,sp,-16
    800071b2:	e406                	sd	ra,8(sp)
    800071b4:	e022                	sd	s0,0(sp)
    800071b6:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    800071b8:	ffffa097          	auipc	ra,0xffffa
    800071bc:	ccc080e7          	jalr	-820(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071c0:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800071c4:	8b89                	andi	a5,a5,2
  if(intr_get())
    800071c6:	e78d                	bnez	a5,800071f0 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    800071c8:	5d3c                	lw	a5,120(a0)
    800071ca:	02f05b63          	blez	a5,80007200 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    800071ce:	37fd                	addiw	a5,a5,-1
    800071d0:	0007871b          	sext.w	a4,a5
    800071d4:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071d6:	eb09                	bnez	a4,800071e8 <pop_off+0x38>
    800071d8:	5d7c                	lw	a5,124(a0)
    800071da:	c799                	beqz	a5,800071e8 <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071dc:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071e0:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071e4:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071e8:	60a2                	ld	ra,8(sp)
    800071ea:	6402                	ld	s0,0(sp)
    800071ec:	0141                	addi	sp,sp,16
    800071ee:	8082                	ret
    panic("pop_off - interruptible");
    800071f0:	00002517          	auipc	a0,0x2
    800071f4:	69050513          	addi	a0,a0,1680 # 80009880 <digits+0x28>
    800071f8:	00000097          	auipc	ra,0x0
    800071fc:	a1a080e7          	jalr	-1510(ra) # 80006c12 <panic>
    panic("pop_off");
    80007200:	00002517          	auipc	a0,0x2
    80007204:	69850513          	addi	a0,a0,1688 # 80009898 <digits+0x40>
    80007208:	00000097          	auipc	ra,0x0
    8000720c:	a0a080e7          	jalr	-1526(ra) # 80006c12 <panic>

0000000080007210 <release>:
{
    80007210:	1101                	addi	sp,sp,-32
    80007212:	ec06                	sd	ra,24(sp)
    80007214:	e822                	sd	s0,16(sp)
    80007216:	e426                	sd	s1,8(sp)
    80007218:	1000                	addi	s0,sp,32
    8000721a:	84aa                	mv	s1,a0
  if(!holding(lk))
    8000721c:	00000097          	auipc	ra,0x0
    80007220:	ec6080e7          	jalr	-314(ra) # 800070e2 <holding>
    80007224:	c115                	beqz	a0,80007248 <release+0x38>
  lk->cpu = 0;
    80007226:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    8000722a:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    8000722e:	0f50000f          	fence	iorw,ow
    80007232:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    80007236:	00000097          	auipc	ra,0x0
    8000723a:	f7a080e7          	jalr	-134(ra) # 800071b0 <pop_off>
}
    8000723e:	60e2                	ld	ra,24(sp)
    80007240:	6442                	ld	s0,16(sp)
    80007242:	64a2                	ld	s1,8(sp)
    80007244:	6105                	addi	sp,sp,32
    80007246:	8082                	ret
    panic("release");
    80007248:	00002517          	auipc	a0,0x2
    8000724c:	65850513          	addi	a0,a0,1624 # 800098a0 <digits+0x48>
    80007250:	00000097          	auipc	ra,0x0
    80007254:	9c2080e7          	jalr	-1598(ra) # 80006c12 <panic>

0000000080007258 <lockfree_read8>:
...
lockfree_read8(uint64 *addr) {
  ...
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    ...
    80007262:	6108                	ld	a0,0(a0)
    80007264:	0ff0000f          	fence
  return val;
}
    80007268:	6422                	ld	s0,8(sp)
    8000726a:	0141                	addi	sp,sp,16
    8000726c:	8082                	ret

000000008000726e <lockfree_read4>:
...
lockfree_read4(int *addr) {
  ...
  uint32 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    80007274:	0ff0000f          	fence
    80007278:	4108                	lw	a0,0(a0)
    8000727a:	0ff0000f          	fence
  return val;
}
    8000727e:	2501                	sext.w	a0,a0
